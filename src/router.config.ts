...
export const routerConfig = [
    ...
    },
    {
        path: 'amims',
        children: [
            { path: 'actype', module: ActypeModule },
            { path: 'aircraft', module: AircraftModule },
            { path: 'aircraft_detail', module: AircraftDetailModule },
            { path: 'ata', module: AtaModule },
            { path: 'bin', module: BinModule },
            ...
            { path: 'engineer_pris', module: EngineerPrisModule },
            { path: 'engineer_pris_item', module: EngineerPrisItemModule },
            { path: 'engineer_pris_return', module: EngineerPrisReturnModule },
            { path: 'engineer_pris_return_item', module: EngineerPrisReturnItemModule },
            { path: 'engineer_rti', module: EngineerRtiModule },
            { path: 'engineer_rti_identify', module: EngineerRtiIdentifyModule },
            { path: 'engineer_rti_part', module: EngineerRtiPartModule },
            { path: 'figure_index', module: FigureIndexModule },
            ...
            { path: 'log_process', module: LogProcessModule },
            { path: 'log_sp', module: LogSpModule },
            { path: 'log_transfer', module: LogTransferModule },
            ...
            { path: 'part_ata', module: PartAtaModule },
            { path: 'part_category', module: PartCategoryModule },
            { path: 'part_condition', module: PartConditionModule },
            { path: 'part_figure_index', module: PartFigureIndexModule },
            { path: 'part_install', module: PartInstallModule },
            { path: 'part_install_old', module: PartInstallOldModule },
            { path: 'part_log', module: PartLogModule },
            { path: 'partid', module: PartidModule },
            { path: 'pilot', module: PilotModule },
            { path: 'position', module: PositionModule },
            { path: 'pur_grn', module: PurGrnModule },
            { path: 'pur_grn_item', module: PurGrnItemModule },
            { path: 'pur_po', module: PurPoModule },
            { path: 'pur_po_item', module: PurPoItemModule },
            { path: 'pur_pr', module: PurPrModule },
            { path: 'pur_pr_item', module: PurPrItemModule },
            { path: 'pur_prcl', module: PurPrclModule },
            { path: 'pur_return', module: PurReturnModule },
            { path: 'pur_return_item', module: PurReturnItemModule },
            { path: 'pur_vendor', module: PurVendorModule },
            { path: 'pur_vendor_contact', module: PurVendorContactModule },
            { path: 'pur_vendor_item', module: PurVendorItemModule },
            { path: 'qa_rpd', module: QaRpdModule },
            { path: 'qa_rpd_dispotition', module: QaRpdDispotitionModule },
            { path: 'qa_transfer', module: QaTransferModule },
            { path: 'qa_transfer_item', module: QaTransferItemModule },
            { path: 'rotary_factor', module: RotaryFactorModule },
            { path: 'shipping', module: ShippingModule },
            { path: 'site', module: SiteModule },
            { path: 'store_destroy', module: StoreDestroyModule },
            { path: 'store_transfer', module: StoreTransferModule },
            { path: 'store_transfer_item', module: StoreTransferItemModule },
            { path: 'td', module: TdModule },
            { path: 'td_detail', module: TdDetailModule },
            { path: 'td_detail_ac', module: TdDetailAcModule },
            { path: 'td_ref', module: TdRefModule },
            { path: 'td_type', module: TdTypeModule },
            { path: 'tech_defect', module: TechDefectModule },
            { path: 'tech_discrepancies', module: TechDiscrepanciesModule },
            { path: 'tech_log', module: TechLogModule },
            { path: 'tech_log_engine', module: TechLogEngineModule },
            { path: 'tech_log_engine_check', module: TechLogEngineCheckModule },
            { path: 'tech_log_item', module: TechLogItemModule },
