...
import { AmimsPilotWidgetDto } from 'src/dto/amims/amims.pilot-widget.dto';

@ApiTags('pilot_widget')
@Controller('pilot_widget')
export class PilotWidgetController {
    constructor(private readonly service: PilotWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPilotWidgetDto, 'list')
    async findAll(
