...
export class PilotController {
    ...
    @Get()
    @ApiResponseEntity(AmimsPilotDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPilotDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPilotDto }) 
    @ApiResponseEntity(AmimsPilotDto, 'post')
    async create(@Body() body: AmimsPilotDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPilotDto })
    @ApiResponseEntity(AmimsPilotDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPilotDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPilotDto, 'delete')
