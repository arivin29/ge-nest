...
@ApiTags('engineer_rti_part')
@Controller('engineer_rti_part')
export class EngineerRtiPartController {
    constructor(private readonly service: EngineerRtiPartService) { }

    @Get()
    @ApiResponseEntity(AmimsEngineerRtiPartDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerRtiPartDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsEngineerRtiPartDto }) 
    @ApiResponseEntity(AmimsEngineerRtiPartDto, 'post')
    async create(@Body() body: AmimsEngineerRtiPartDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsEngineerRtiPartDto })
    @ApiResponseEntity(AmimsEngineerRtiPartDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsEngineerRtiPartDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsEngineerRtiPartDto, 'delete')
