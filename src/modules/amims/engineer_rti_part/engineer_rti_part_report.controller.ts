...
import { EngineerRtiPartService } from '../engineer_rti_part/engineer_rti_part.service';
...
import { AmimsEngineerRtiPartReportDto } from 'src/dto/amims/amims.engineer_rti_part-report.dto';;

@ApiTags('engineer_rti_part_report')
@Controller('engineer_rti_part_report')
export class EngineerRtiPartReportController {
    constructor(private readonly service: EngineerRtiPartService) { }

    @Post('list')
    @ApiResponseEntity(AmimsEngineerRtiPartReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerRtiPartReportDto, 'get')
