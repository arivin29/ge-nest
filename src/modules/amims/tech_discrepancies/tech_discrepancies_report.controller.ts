...
import { TechDiscrepanciesService } from '../tech_discrepancies/tech_discrepancies.service';
...
import { AmimsTechDiscrepanciesReportDto } from 'src/dto/amims/amims.tech_discrepancies-report.dto';;

@ApiTags('tech_discrepancies_report')
@Controller('tech_discrepancies_report')
export class TechDiscrepanciesReportController {
    constructor(private readonly service: TechDiscrepanciesService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTechDiscrepanciesReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechDiscrepanciesReportDto, 'get')
