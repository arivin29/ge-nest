...
@ApiTags('tech_discrepancies')
@Controller('tech_discrepancies')
export class TechDiscrepanciesController {
    constructor(private readonly service: TechDiscrepanciesService) { }

    @Get()
    @ApiResponseEntity(AmimsTechDiscrepanciesDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechDiscrepanciesDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTechDiscrepanciesDto }) 
    @ApiResponseEntity(AmimsTechDiscrepanciesDto, 'post')
    async create(@Body() body: AmimsTechDiscrepanciesDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTechDiscrepanciesDto })
    @ApiResponseEntity(AmimsTechDiscrepanciesDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTechDiscrepanciesDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTechDiscrepanciesDto, 'delete')
