...
import { AmimsCurrencyWidgetDto } from 'src/dto/amims/amims.currency-widget.dto';

@ApiTags('currency_widget')
@Controller('currency_widget')
export class CurrencyWidgetController {
    constructor(private readonly service: CurrencyWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsCurrencyWidgetDto, 'list')
    async findAll(
