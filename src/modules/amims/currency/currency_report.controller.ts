...
import { AmimsCurrencyReportDto } from 'src/dto/amims/amims.currency-report.dto';;

@ApiTags('currency_report')
@Controller('currency_report')
export class CurrencyReportController {
    constructor(private readonly service: CurrencyService) { }

    @Post('list')
    @ApiResponseEntity(AmimsCurrencyReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsCurrencyReportDto, 'get')
