...
import { AmimsCurrencyDto } from 'src/dto/amims/amims.currency.dto';; 
...
export class CurrencyController {
    ...
    @Get()
    @ApiResponseEntity(AmimsCurrencyDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsCurrencyDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsCurrencyDto }) 
    @ApiResponseEntity(AmimsCurrencyDto, 'post')
    async create(@Body() body: AmimsCurrencyDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsCurrencyDto })
    @ApiResponseEntity(AmimsCurrencyDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsCurrencyDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsCurrencyDto, 'delete')
