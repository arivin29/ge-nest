...
import { WpJoService } from '../wp_jo/wp_jo.service';
...
import { AmimsWpJoReportDto } from 'src/dto/amims/amims.wp_jo-report.dto';;

@ApiTags('wp_jo_report')
@Controller('wp_jo_report')
export class WpJoReportController {
    constructor(private readonly service: WpJoService) { }

    @Post('list')
    @ApiResponseEntity(AmimsWpJoReportDto, 'list')
    async findAll(
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsWpJoReportDto, 'get')
