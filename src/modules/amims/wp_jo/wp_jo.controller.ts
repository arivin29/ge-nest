...
@ApiTags('wp_jo')
@Controller('wp_jo')
export class WpJoController {
    constructor(private readonly service: WpJoService) { }

    @Get()
    @ApiResponseEntity(AmimsWpJoDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsWpJoDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsWpJoDto }) 
    @ApiResponseEntity(AmimsWpJoDto, 'post')
    async create(@Body() body: AmimsWpJoDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsWpJoDto })
    @ApiResponseEntity(AmimsWpJoDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsWpJoDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsWpJoDto, 'delete')
