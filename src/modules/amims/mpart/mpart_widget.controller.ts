...
import { AmimsMpartWidgetDto } from 'src/dto/amims/amims.mpart-widget.dto';

@ApiTags('mpart_widget')
@Controller('mpart_widget')
export class MpartWidgetController {
    constructor(private readonly service: MpartWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsMpartWidgetDto, 'list')
    async findAll(
