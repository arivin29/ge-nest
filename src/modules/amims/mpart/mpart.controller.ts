...
@ApiTags('mpart')
@Controller('mpart')
export class MpartController {
    constructor(private readonly service: MpartService) { }

    @Get()
    @ApiResponseEntity(AmimsMpartDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpartDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMpartDto }) 
    @ApiResponseEntity(AmimsMpartDto, 'post')
    async create(@Body() body: AmimsMpartDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMpartDto })
    @ApiResponseEntity(AmimsMpartDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMpartDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMpartDto, 'delete')
