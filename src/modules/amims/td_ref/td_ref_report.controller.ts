...
import { TdRefService } from '../td_ref/td_ref.service';
...
import { AmimsTdRefReportDto } from 'src/dto/amims/amims.td_ref-report.dto';;

@ApiTags('td_ref_report')
@Controller('td_ref_report')
export class TdRefReportController {
    constructor(private readonly service: TdRefService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTdRefReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTdRefReportDto, 'get')
