...
import { AmimsTdRefWidgetDto } from 'src/dto/amims/amims.td_ref-widget.dto';

@ApiTags('td_ref_widget')
@Controller('td_ref_widget')
export class TdRefWidgetController {
    constructor(private readonly service: TdRefWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsTdRefWidgetDto, 'list')
    async findAll(
