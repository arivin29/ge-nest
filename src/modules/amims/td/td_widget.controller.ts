...
import { AmimsTdWidgetDto } from 'src/dto/amims/amims.td-widget.dto';

@ApiTags('td_widget')
@Controller('td_widget')
export class TdWidgetController {
    constructor(private readonly service: TdWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsTdWidgetDto, 'list')
    async findAll(
