...
import { AmimsTdReportDto } from 'src/dto/amims/amims.td-report.dto';;

@ApiTags('td_report')
@Controller('td_report')
export class TdReportController {
    constructor(private readonly service: TdService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTdReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTdReportDto, 'get')
