...
export class TdController {
    constructor(private readonly service: TdService) { }

    @Get()
    @ApiResponseEntity(AmimsTdDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTdDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTdDto }) 
    @ApiResponseEntity(AmimsTdDto, 'post')
    async create(@Body() body: AmimsTdDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTdDto })
    @ApiResponseEntity(AmimsTdDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTdDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTdDto, 'delete')
