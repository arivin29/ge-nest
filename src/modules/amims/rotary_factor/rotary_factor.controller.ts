...
@ApiTags('rotary_factor')
@Controller('rotary_factor')
export class RotaryFactorController {
    constructor(private readonly service: RotaryFactorService) { }

    @Get()
    @ApiResponseEntity(AmimsRotaryFactorDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsRotaryFactorDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsRotaryFactorDto }) 
    @ApiResponseEntity(AmimsRotaryFactorDto, 'post')
    async create(@Body() body: AmimsRotaryFactorDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsRotaryFactorDto })
    @ApiResponseEntity(AmimsRotaryFactorDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsRotaryFactorDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsRotaryFactorDto, 'delete')
