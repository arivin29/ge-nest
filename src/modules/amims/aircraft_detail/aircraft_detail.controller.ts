...
@ApiTags('aircraft_detail')
@Controller('aircraft_detail')
export class AircraftDetailController {
    constructor(private readonly service: AircraftDetailService) { }

    @Get()
    @ApiResponseEntity(AmimsAircraftDetailDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsAircraftDetailDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsAircraftDetailDto }) 
    @ApiResponseEntity(AmimsAircraftDetailDto, 'post')
    async create(@Body() body: AmimsAircraftDetailDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsAircraftDetailDto })
    @ApiResponseEntity(AmimsAircraftDetailDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsAircraftDetailDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsAircraftDetailDto, 'delete')
