...
import { AircraftDetailService } from '../aircraft_detail/aircraft_detail.service';
...
import { AmimsAircraftDetailReportDto } from 'src/dto/amims/amims.aircraft_detail-report.dto';;

@ApiTags('aircraft_detail_report')
@Controller('aircraft_detail_report')
export class AircraftDetailReportController {
    constructor(private readonly service: AircraftDetailService) { }

    @Post('list')
    @ApiResponseEntity(AmimsAircraftDetailReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsAircraftDetailReportDto, 'get')
