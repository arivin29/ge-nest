...
import { PartAtaService } from '../part_ata/part_ata.service';
...
import { AmimsPartAtaReportDto } from 'src/dto/amims/amims.part_ata-report.dto';;

@ApiTags('part_ata_report')
@Controller('part_ata_report')
export class PartAtaReportController {
    constructor(private readonly service: PartAtaService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartAtaReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartAtaReportDto, 'get')
