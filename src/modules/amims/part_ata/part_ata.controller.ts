...
@ApiTags('part_ata')
@Controller('part_ata')
export class PartAtaController {
    constructor(private readonly service: PartAtaService) { }

    @Get()
    @ApiResponseEntity(AmimsPartAtaDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartAtaDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartAtaDto }) 
    @ApiResponseEntity(AmimsPartAtaDto, 'post')
    async create(@Body() body: AmimsPartAtaDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartAtaDto })
    @ApiResponseEntity(AmimsPartAtaDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartAtaDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartAtaDto, 'delete')
