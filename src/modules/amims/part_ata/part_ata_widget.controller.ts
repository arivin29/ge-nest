...
import { AmimsPartAtaWidgetDto } from 'src/dto/amims/amims.part_ata-widget.dto';

@ApiTags('part_ata_widget')
@Controller('part_ata_widget')
export class PartAtaWidgetController {
    constructor(private readonly service: PartAtaWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPartAtaWidgetDto, 'list')
    async findAll(
