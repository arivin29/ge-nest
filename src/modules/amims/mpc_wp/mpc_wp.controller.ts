...
@ApiTags('mpc_wp')
@Controller('mpc_wp')
export class MpcWpController {
    constructor(private readonly service: MpcWpService) { }

    @Get()
    @ApiResponseEntity(AmimsMpcWpDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcWpDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMpcWpDto }) 
    @ApiResponseEntity(AmimsMpcWpDto, 'post')
    async create(@Body() body: AmimsMpcWpDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMpcWpDto })
    @ApiResponseEntity(AmimsMpcWpDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMpcWpDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMpcWpDto, 'delete')
