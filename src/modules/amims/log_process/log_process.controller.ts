...
@ApiTags('log_process')
@Controller('log_process')
export class LogProcessController {
    constructor(private readonly service: LogProcessService) { }

    @Get()
    @ApiResponseEntity(AmimsLogProcessDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLogProcessDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLogProcessDto }) 
    @ApiResponseEntity(AmimsLogProcessDto, 'post')
    async create(@Body() body: AmimsLogProcessDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLogProcessDto })
    @ApiResponseEntity(AmimsLogProcessDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLogProcessDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLogProcessDto, 'delete')
