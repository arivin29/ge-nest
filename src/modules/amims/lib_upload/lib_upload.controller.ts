...
import { AmimsLibUploadDto } from 'src/dto/amims/amims.lib_upload.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('lib_upload')
@Controller('lib_upload')
export class LibUploadController {
    constructor(private readonly service: LibUploadService) { }

    @Get()
    @ApiResponseEntity(AmimsLibUploadDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLibUploadDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLibUploadDto }) 
    @ApiResponseEntity(AmimsLibUploadDto, 'post')
    async create(@Body() body: AmimsLibUploadDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLibUploadDto })
    @ApiResponseEntity(AmimsLibUploadDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLibUploadDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLibUploadDto, 'delete')
