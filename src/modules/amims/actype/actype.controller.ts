...
export class ActypeController {
    constructor(private readonly service: ActypeService) { }

    @Get()
    @ApiResponseEntity(AmimsActypeDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsActypeDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsActypeDto }) 
    @ApiResponseEntity(AmimsActypeDto, 'post')
    async create(@Body() body: AmimsActypeDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsActypeDto })
    @ApiResponseEntity(AmimsActypeDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsActypeDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsActypeDto, 'delete')
