...
import { AmimsActypeWidgetDto } from 'src/dto/amims/amims.actype-widget.dto';

@ApiTags('actype_widget')
@Controller('actype_widget')
export class ActypeWidgetController {
    constructor(private readonly service: ActypeWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsActypeWidgetDto, 'list')
    async findAll(
