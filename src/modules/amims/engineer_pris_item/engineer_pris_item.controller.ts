...
@ApiTags('engineer_pris_item')
@Controller('engineer_pris_item')
export class EngineerPrisItemController {
    constructor(private readonly service: EngineerPrisItemService) { }

    @Get()
    @ApiResponseEntity(AmimsEngineerPrisItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPrisItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsEngineerPrisItemDto }) 
    @ApiResponseEntity(AmimsEngineerPrisItemDto, 'post')
    async create(@Body() body: AmimsEngineerPrisItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsEngineerPrisItemDto })
    @ApiResponseEntity(AmimsEngineerPrisItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsEngineerPrisItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsEngineerPrisItemDto, 'delete')
