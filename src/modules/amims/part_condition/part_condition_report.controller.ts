...
import { PartConditionService } from '../part_condition/part_condition.service';
...
import { AmimsPartConditionReportDto } from 'src/dto/amims/amims.part_condition-report.dto';;

@ApiTags('part_condition_report')
@Controller('part_condition_report')
export class PartConditionReportController {
    constructor(private readonly service: PartConditionService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartConditionReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartConditionReportDto, 'get')
