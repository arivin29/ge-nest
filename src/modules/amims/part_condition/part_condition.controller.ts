...
@ApiTags('part_condition')
@Controller('part_condition')
export class PartConditionController {
    constructor(private readonly service: PartConditionService) { }

    @Get()
    @ApiResponseEntity(AmimsPartConditionDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartConditionDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartConditionDto }) 
    @ApiResponseEntity(AmimsPartConditionDto, 'post')
    async create(@Body() body: AmimsPartConditionDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartConditionDto })
    @ApiResponseEntity(AmimsPartConditionDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartConditionDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartConditionDto, 'delete')
