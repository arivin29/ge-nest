...
import { EngineerPrisReturnService } from '../engineer_pris_return/engineer_pris_return.service';
...
import { AmimsEngineerPrisReturnReportDto } from 'src/dto/amims/amims.engineer_pris_return-report.dto';;

@ApiTags('engineer_pris_return_report')
@Controller('engineer_pris_return_report')
export class EngineerPrisReturnReportController {
    constructor(private readonly service: EngineerPrisReturnService) { }

    @Post('list')
    @ApiResponseEntity(AmimsEngineerPrisReturnReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPrisReturnReportDto, 'get')
