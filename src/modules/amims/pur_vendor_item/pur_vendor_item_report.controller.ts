...
import { PurVendorItemService } from '../pur_vendor_item/pur_vendor_item.service';
...
import { AmimsPurVendorItemReportDto } from 'src/dto/amims/amims.pur_vendor_item-report.dto';;

@ApiTags('pur_vendor_item_report')
@Controller('pur_vendor_item_report')
export class PurVendorItemReportController {
    constructor(private readonly service: PurVendorItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPurVendorItemReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurVendorItemReportDto, 'get')
