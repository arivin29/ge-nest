...
@ApiTags('pur_vendor_item')
@Controller('pur_vendor_item')
export class PurVendorItemController {
    constructor(private readonly service: PurVendorItemService) { }

    @Get()
    @ApiResponseEntity(AmimsPurVendorItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurVendorItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurVendorItemDto }) 
    @ApiResponseEntity(AmimsPurVendorItemDto, 'post')
    async create(@Body() body: AmimsPurVendorItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurVendorItemDto })
    @ApiResponseEntity(AmimsPurVendorItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurVendorItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurVendorItemDto, 'delete')
