...
@ApiTags('due_list_output')
@Controller('due_list_output')
export class DueListOutputController {
    constructor(private readonly service: DueListOutputService) { }

    @Get()
    @ApiResponseEntity(AmimsDueListOutputDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsDueListOutputDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsDueListOutputDto }) 
    @ApiResponseEntity(AmimsDueListOutputDto, 'post')
    async create(@Body() body: AmimsDueListOutputDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsDueListOutputDto })
    @ApiResponseEntity(AmimsDueListOutputDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsDueListOutputDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsDueListOutputDto, 'delete')
