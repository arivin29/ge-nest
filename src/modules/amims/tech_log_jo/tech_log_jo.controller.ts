...
@ApiTags('tech_log_jo')
@Controller('tech_log_jo')
export class TechLogJoController {
    constructor(private readonly service: TechLogJoService) { }

    @Get()
    @ApiResponseEntity(AmimsTechLogJoDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechLogJoDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTechLogJoDto }) 
    @ApiResponseEntity(AmimsTechLogJoDto, 'post')
    async create(@Body() body: AmimsTechLogJoDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTechLogJoDto })
    @ApiResponseEntity(AmimsTechLogJoDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTechLogJoDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTechLogJoDto, 'delete')
