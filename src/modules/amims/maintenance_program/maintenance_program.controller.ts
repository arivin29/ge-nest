...
@ApiTags('maintenance_program')
@Controller('maintenance_program')
export class MaintenanceProgramController {
    constructor(private readonly service: MaintenanceProgramService) { }

    @Get()
    @ApiResponseEntity(AmimsMaintenanceProgramDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceProgramDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceProgramDto }) 
    @ApiResponseEntity(AmimsMaintenanceProgramDto, 'post')
    async create(@Body() body: AmimsMaintenanceProgramDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceProgramDto })
    @ApiResponseEntity(AmimsMaintenanceProgramDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceProgramDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceProgramDto, 'delete')
