...
@ApiTags('tech_log_engine_check')
@Controller('tech_log_engine_check')
export class TechLogEngineCheckController {
    constructor(private readonly service: TechLogEngineCheckService) { }

    @Get()
    @ApiResponseEntity(AmimsTechLogEngineCheckDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechLogEngineCheckDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTechLogEngineCheckDto }) 
    @ApiResponseEntity(AmimsTechLogEngineCheckDto, 'post')
    async create(@Body() body: AmimsTechLogEngineCheckDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTechLogEngineCheckDto })
    @ApiResponseEntity(AmimsTechLogEngineCheckDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTechLogEngineCheckDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTechLogEngineCheckDto, 'delete')
