...
import { TechLogEngineCheckService } from '../tech_log_engine_check/tech_log_engine_check.service';
...
import { AmimsTechLogEngineCheckReportDto } from 'src/dto/amims/amims.tech_log_engine_check-report.dto';;

@ApiTags('tech_log_engine_check_report')
@Controller('tech_log_engine_check_report')
export class TechLogEngineCheckReportController {
    constructor(private readonly service: TechLogEngineCheckService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTechLogEngineCheckReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'tech_log_engine', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechLogEngineCheckReportDto, 'get')
