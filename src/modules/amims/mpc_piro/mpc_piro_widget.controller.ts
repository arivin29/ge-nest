...
import { AmimsMpcPiroWidgetDto } from 'src/dto/amims/amims.mpc_piro-widget.dto';

@ApiTags('mpc_piro_widget')
@Controller('mpc_piro_widget')
export class MpcPiroWidgetController {
    constructor(private readonly service: MpcPiroWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsMpcPiroWidgetDto, 'list')
    async findAll(
