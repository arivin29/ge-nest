...
@ApiTags('mpc_piro')
@Controller('mpc_piro')
export class MpcPiroController {
    constructor(private readonly service: MpcPiroService) { }

    @Get()
    @ApiResponseEntity(AmimsMpcPiroDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcPiroDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMpcPiroDto }) 
    @ApiResponseEntity(AmimsMpcPiroDto, 'post')
    async create(@Body() body: AmimsMpcPiroDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMpcPiroDto })
    @ApiResponseEntity(AmimsMpcPiroDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMpcPiroDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMpcPiroDto, 'delete')
