...
import { MpcPiroService } from '../mpc_piro/mpc_piro.service';
...
import { AmimsMpcPiroReportDto } from 'src/dto/amims/amims.mpc_piro-report.dto';;

@ApiTags('mpc_piro_report')
@Controller('mpc_piro_report')
export class MpcPiroReportController {
    constructor(private readonly service: MpcPiroService) { }

    @Post('list')
    @ApiResponseEntity(AmimsMpcPiroReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcPiroReportDto, 'get')
