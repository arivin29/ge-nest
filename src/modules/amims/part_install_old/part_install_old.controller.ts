...
@ApiTags('part_install_old')
@Controller('part_install_old')
export class PartInstallOldController {
    constructor(private readonly service: PartInstallOldService) { }

    @Get()
    @ApiResponseEntity(AmimsPartInstallOldDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartInstallOldDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartInstallOldDto }) 
    @ApiResponseEntity(AmimsPartInstallOldDto, 'post')
    async create(@Body() body: AmimsPartInstallOldDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartInstallOldDto })
    @ApiResponseEntity(AmimsPartInstallOldDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartInstallOldDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartInstallOldDto, 'delete')
