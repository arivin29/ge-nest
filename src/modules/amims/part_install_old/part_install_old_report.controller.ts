...
import { PartInstallOldService } from '../part_install_old/part_install_old.service';
...
import { AmimsPartInstallOldReportDto } from 'src/dto/amims/amims.part_install_old-report.dto';;

@ApiTags('part_install_old_report')
@Controller('part_install_old_report')
export class PartInstallOldReportController {
    constructor(private readonly service: PartInstallOldService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartInstallOldReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartInstallOldReportDto, 'get')
