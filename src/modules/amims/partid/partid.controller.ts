...
@ApiTags('partid')
@Controller('partid')
export class PartidController {
    constructor(private readonly service: PartidService) { }

    @Get()
    @ApiResponseEntity(AmimsPartidDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartidDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartidDto }) 
    @ApiResponseEntity(AmimsPartidDto, 'post')
    async create(@Body() body: AmimsPartidDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartidDto })
    @ApiResponseEntity(AmimsPartidDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartidDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartidDto, 'delete')
