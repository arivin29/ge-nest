...
import { PartidService } from '../partid/partid.service';
...
import { AmimsPartidReportDto } from 'src/dto/amims/amims.partid-report.dto';;

@ApiTags('partid_report')
@Controller('partid_report')
export class PartidReportController {
    constructor(private readonly service: PartidService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartidReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartidReportDto, 'get')
