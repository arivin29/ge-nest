...
import { AmimsPartidWidgetDto } from 'src/dto/amims/amims.partid-widget.dto';

@ApiTags('partid_widget')
@Controller('partid_widget')
export class PartidWidgetController {
    constructor(private readonly service: PartidWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPartidWidgetDto, 'list')
    async findAll(
