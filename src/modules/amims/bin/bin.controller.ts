...
export class BinController {
    ...
    @Get()
    @ApiResponseEntity(AmimsBinDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsBinDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsBinDto }) 
    @ApiResponseEntity(AmimsBinDto, 'post')
    async create(@Body() body: AmimsBinDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsBinDto })
    @ApiResponseEntity(AmimsBinDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsBinDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsBinDto, 'delete')
