...
import { AmimsBinWidgetDto } from 'src/dto/amims/amims.bin-widget.dto';

@ApiTags('bin_widget')
@Controller('bin_widget')
export class BinWidgetController {
    constructor(private readonly service: BinWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsBinWidgetDto, 'list')
    async findAll(
