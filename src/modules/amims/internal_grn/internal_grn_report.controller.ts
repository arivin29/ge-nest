...
import { InternalGrnService } from '../internal_grn/internal_grn.service';
...
import { AmimsInternalGrnReportDto } from 'src/dto/amims/amims.internal_grn-report.dto';;

@ApiTags('internal_grn_report')
@Controller('internal_grn_report')
export class InternalGrnReportController {
    constructor(private readonly service: InternalGrnService) { }

    @Post('list')
    @ApiResponseEntity(AmimsInternalGrnReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsInternalGrnReportDto, 'get')
