...
@ApiTags('internal_grn')
@Controller('internal_grn')
export class InternalGrnController {
    constructor(private readonly service: InternalGrnService) { }

    @Get()
    @ApiResponseEntity(AmimsInternalGrnDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsInternalGrnDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsInternalGrnDto }) 
    @ApiResponseEntity(AmimsInternalGrnDto, 'post')
    async create(@Body() body: AmimsInternalGrnDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsInternalGrnDto })
    @ApiResponseEntity(AmimsInternalGrnDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsInternalGrnDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsInternalGrnDto, 'delete')
