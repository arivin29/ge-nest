...
import { TdDetailAcService } from '../td_detail_ac/td_detail_ac.service';
...
import { AmimsTdDetailAcReportDto } from 'src/dto/amims/amims.td_detail_ac-report.dto';;

@ApiTags('td_detail_ac_report')
@Controller('td_detail_ac_report')
export class TdDetailAcReportController {
    constructor(private readonly service: TdDetailAcService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTdDetailAcReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTdDetailAcReportDto, 'get')
