...
@ApiTags('td_detail_ac')
@Controller('td_detail_ac')
export class TdDetailAcController {
    constructor(private readonly service: TdDetailAcService) { }

    @Get()
    @ApiResponseEntity(AmimsTdDetailAcDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTdDetailAcDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTdDetailAcDto }) 
    @ApiResponseEntity(AmimsTdDetailAcDto, 'post')
    async create(@Body() body: AmimsTdDetailAcDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTdDetailAcDto })
    @ApiResponseEntity(AmimsTdDetailAcDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTdDetailAcDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTdDetailAcDto, 'delete')
