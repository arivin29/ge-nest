...
@ApiTags('maintenance_program_item')
@Controller('maintenance_program_item')
export class MaintenanceProgramItemController {
    constructor(private readonly service: MaintenanceProgramItemService) { }

    @Get()
    @ApiResponseEntity(AmimsMaintenanceProgramItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceProgramItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceProgramItemDto }) 
    @ApiResponseEntity(AmimsMaintenanceProgramItemDto, 'post')
    async create(@Body() body: AmimsMaintenanceProgramItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceProgramItemDto })
    @ApiResponseEntity(AmimsMaintenanceProgramItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceProgramItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceProgramItemDto, 'delete')
