...
import { MaintenanceProgramItemService } from '../maintenance_program_item/maintenance_program_item.service';
...
import { AmimsMaintenanceProgramItemReportDto } from 'src/dto/amims/amims.maintenance_program_item-report.dto';;

@ApiTags('maintenance_program_item_report')
@Controller('maintenance_program_item_report')
export class MaintenanceProgramItemReportController {
    constructor(private readonly service: MaintenanceProgramItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsMaintenanceProgramItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'maintenance_program', type: 'single' },
                                                { name: 'maintenance', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceProgramItemReportDto, 'get')
