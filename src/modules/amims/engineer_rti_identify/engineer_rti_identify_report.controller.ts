...
import { EngineerRtiIdentifyService } from '../engineer_rti_identify/engineer_rti_identify.service';
...
import { AmimsEngineerRtiIdentifyReportDto } from 'src/dto/amims/amims.engineer_rti_identify-report.dto';;

@ApiTags('engineer_rti_identify_report')
@Controller('engineer_rti_identify_report')
export class EngineerRtiIdentifyReportController {
    constructor(private readonly service: EngineerRtiIdentifyService) { }

    @Post('list')
    @ApiResponseEntity(AmimsEngineerRtiIdentifyReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerRtiIdentifyReportDto, 'get')
