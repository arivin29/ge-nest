...
@ApiTags('engineer_rti_identify')
@Controller('engineer_rti_identify')
export class EngineerRtiIdentifyController {
    constructor(private readonly service: EngineerRtiIdentifyService) { }

    @Get()
    @ApiResponseEntity(AmimsEngineerRtiIdentifyDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerRtiIdentifyDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsEngineerRtiIdentifyDto }) 
    @ApiResponseEntity(AmimsEngineerRtiIdentifyDto, 'post')
    async create(@Body() body: AmimsEngineerRtiIdentifyDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsEngineerRtiIdentifyDto })
    @ApiResponseEntity(AmimsEngineerRtiIdentifyDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsEngineerRtiIdentifyDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsEngineerRtiIdentifyDto, 'delete')
