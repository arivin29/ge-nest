...
import { AmimsShippingWidgetDto } from 'src/dto/amims/amims.shipping-widget.dto';

@ApiTags('shipping_widget')
@Controller('shipping_widget')
export class ShippingWidgetController {
    constructor(private readonly service: ShippingWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsShippingWidgetDto, 'list')
    async findAll(
