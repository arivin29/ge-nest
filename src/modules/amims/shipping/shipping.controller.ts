...
import { AmimsShippingDto } from 'src/dto/amims/amims.shipping.dto';; 
...
export class ShippingController {
    ...
    @Get()
    @ApiResponseEntity(AmimsShippingDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsShippingDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsShippingDto }) 
    @ApiResponseEntity(AmimsShippingDto, 'post')
    async create(@Body() body: AmimsShippingDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsShippingDto })
    @ApiResponseEntity(AmimsShippingDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsShippingDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsShippingDto, 'delete')
