...
import { EngineerPrisReturnItemService } from '../engineer_pris_return_item/engineer_pris_return_item.service';
...
import { AmimsEngineerPrisReturnItemReportDto } from 'src/dto/amims/amims.engineer_pris_return_item-report.dto';;

@ApiTags('engineer_pris_return_item_report')
@Controller('engineer_pris_return_item_report')
export class EngineerPrisReturnItemReportController {
    constructor(private readonly service: EngineerPrisReturnItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsEngineerPrisReturnItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'engineer_pris_item', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPrisReturnItemReportDto, 'get')
