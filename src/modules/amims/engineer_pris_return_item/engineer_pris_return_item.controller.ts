...
@ApiTags('engineer_pris_return_item')
@Controller('engineer_pris_return_item')
export class EngineerPrisReturnItemController {
    constructor(private readonly service: EngineerPrisReturnItemService) { }

    @Get()
    @ApiResponseEntity(AmimsEngineerPrisReturnItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPrisReturnItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsEngineerPrisReturnItemDto }) 
    @ApiResponseEntity(AmimsEngineerPrisReturnItemDto, 'post')
    async create(@Body() body: AmimsEngineerPrisReturnItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsEngineerPrisReturnItemDto })
    @ApiResponseEntity(AmimsEngineerPrisReturnItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsEngineerPrisReturnItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsEngineerPrisReturnItemDto, 'delete')
