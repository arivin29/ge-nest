...
import { AmimsTdDetailWidgetDto } from 'src/dto/amims/amims.td_detail-widget.dto';

@ApiTags('td_detail_widget')
@Controller('td_detail_widget')
export class TdDetailWidgetController {
    constructor(private readonly service: TdDetailWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsTdDetailWidgetDto, 'list')
    async findAll(
