...
@ApiTags('td_detail')
@Controller('td_detail')
export class TdDetailController {
    constructor(private readonly service: TdDetailService) { }

    @Get()
    @ApiResponseEntity(AmimsTdDetailDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTdDetailDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTdDetailDto }) 
    @ApiResponseEntity(AmimsTdDetailDto, 'post')
    async create(@Body() body: AmimsTdDetailDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTdDetailDto })
    @ApiResponseEntity(AmimsTdDetailDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTdDetailDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTdDetailDto, 'delete')
