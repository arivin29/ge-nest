...
import { TdDetailService } from '../td_detail/td_detail.service';
...
import { AmimsTdDetailReportDto } from 'src/dto/amims/amims.td_detail-report.dto';;

@ApiTags('td_detail_report')
@Controller('td_detail_report')
export class TdDetailReportController {
    constructor(private readonly service: TdDetailService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTdDetailReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                ...
                                                { name: 'acc', type: 'single' },
                                                { name: 'acc_qa', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTdDetailReportDto, 'get')
