...
import { LocationFlightService } from '../location_flight/location_flight.service';
...
import { AmimsLocationFlightReportDto } from 'src/dto/amims/amims.location_flight-report.dto';;

@ApiTags('location_flight_report')
@Controller('location_flight_report')
export class LocationFlightReportController {
    constructor(private readonly service: LocationFlightService) { }

    @Post('list')
    @ApiResponseEntity(AmimsLocationFlightReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLocationFlightReportDto, 'get')
