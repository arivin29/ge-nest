...
import { AmimsLocationFlightDto } from 'src/dto/amims/amims.location_flight.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('location_flight')
@Controller('location_flight')
export class LocationFlightController {
    constructor(private readonly service: LocationFlightService) { }

    @Get()
    @ApiResponseEntity(AmimsLocationFlightDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLocationFlightDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLocationFlightDto }) 
    @ApiResponseEntity(AmimsLocationFlightDto, 'post')
    async create(@Body() body: AmimsLocationFlightDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLocationFlightDto })
    @ApiResponseEntity(AmimsLocationFlightDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLocationFlightDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLocationFlightDto, 'delete')
