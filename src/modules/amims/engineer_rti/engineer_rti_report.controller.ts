...
import { EngineerRtiService } from '../engineer_rti/engineer_rti.service';
...
import { AmimsEngineerRtiReportDto } from 'src/dto/amims/amims.engineer_rti-report.dto';;

@ApiTags('engineer_rti_report')
@Controller('engineer_rti_report')
export class EngineerRtiReportController {
    constructor(private readonly service: EngineerRtiService) { }

    @Post('list')
    @ApiResponseEntity(AmimsEngineerRtiReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerRtiReportDto, 'get')
