...
@ApiTags('engineer_rti')
@Controller('engineer_rti')
export class EngineerRtiController {
    constructor(private readonly service: EngineerRtiService) { }

    @Get()
    @ApiResponseEntity(AmimsEngineerRtiDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerRtiDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsEngineerRtiDto }) 
    @ApiResponseEntity(AmimsEngineerRtiDto, 'post')
    async create(@Body() body: AmimsEngineerRtiDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsEngineerRtiDto })
    @ApiResponseEntity(AmimsEngineerRtiDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsEngineerRtiDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsEngineerRtiDto, 'delete')
