...
@ApiTags('pur_vendor_contact')
@Controller('pur_vendor_contact')
export class PurVendorContactController {
    constructor(private readonly service: PurVendorContactService) { }

    @Get()
    @ApiResponseEntity(AmimsPurVendorContactDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurVendorContactDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurVendorContactDto }) 
    @ApiResponseEntity(AmimsPurVendorContactDto, 'post')
    async create(@Body() body: AmimsPurVendorContactDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurVendorContactDto })
    @ApiResponseEntity(AmimsPurVendorContactDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurVendorContactDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurVendorContactDto, 'delete')
