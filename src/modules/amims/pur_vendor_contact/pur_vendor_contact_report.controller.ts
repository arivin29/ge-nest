...
import { PurVendorContactService } from '../pur_vendor_contact/pur_vendor_contact.service';
...
import { AmimsPurVendorContactReportDto } from 'src/dto/amims/amims.pur_vendor_contact-report.dto';;

@ApiTags('pur_vendor_contact_report')
@Controller('pur_vendor_contact_report')
export class PurVendorContactReportController {
    constructor(private readonly service: PurVendorContactService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPurVendorContactReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurVendorContactReportDto, 'get')
