...
import { AmimsLibFormIssuedDto } from 'src/dto/amims/amims.lib_form_issued.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('lib_form_issued')
@Controller('lib_form_issued')
export class LibFormIssuedController {
    constructor(private readonly service: LibFormIssuedService) { }

    @Get()
    @ApiResponseEntity(AmimsLibFormIssuedDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLibFormIssuedDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLibFormIssuedDto }) 
    @ApiResponseEntity(AmimsLibFormIssuedDto, 'post')
    async create(@Body() body: AmimsLibFormIssuedDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLibFormIssuedDto })
    @ApiResponseEntity(AmimsLibFormIssuedDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLibFormIssuedDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLibFormIssuedDto, 'delete')
