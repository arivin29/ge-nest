...
@ApiTags('part_alternative')
@Controller('part_alternative')
export class PartAlternativeController {
    constructor(private readonly service: PartAlternativeService) { }

    @Get()
    @ApiResponseEntity(AmimsPartAlternativeDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartAlternativeDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartAlternativeDto }) 
    @ApiResponseEntity(AmimsPartAlternativeDto, 'post')
    async create(@Body() body: AmimsPartAlternativeDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartAlternativeDto })
    @ApiResponseEntity(AmimsPartAlternativeDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartAlternativeDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartAlternativeDto, 'delete')
