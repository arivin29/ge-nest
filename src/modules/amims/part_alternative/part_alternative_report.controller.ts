...
import { PartAlternativeService } from '../part_alternative/part_alternative.service';
...
import { AmimsPartAlternativeReportDto } from 'src/dto/amims/amims.part_alternative-report.dto';;

@ApiTags('part_alternative_report')
@Controller('part_alternative_report')
export class PartAlternativeReportController {
    constructor(private readonly service: PartAlternativeService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartAlternativeReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartAlternativeReportDto, 'get')
