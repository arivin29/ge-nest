...
import { AmimsPurPrclWidgetDto } from 'src/dto/amims/amims.pur_prcl-widget.dto';

@ApiTags('pur_prcl_widget')
@Controller('pur_prcl_widget')
export class PurPrclWidgetController {
    constructor(private readonly service: PurPrclWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPurPrclWidgetDto, 'list')
    async findAll(
