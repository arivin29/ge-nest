...
@ApiTags('pur_prcl')
@Controller('pur_prcl')
export class PurPrclController {
    constructor(private readonly service: PurPrclService) { }

    @Get()
    @ApiResponseEntity(AmimsPurPrclDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurPrclDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurPrclDto }) 
    @ApiResponseEntity(AmimsPurPrclDto, 'post')
    async create(@Body() body: AmimsPurPrclDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurPrclDto })
    @ApiResponseEntity(AmimsPurPrclDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurPrclDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurPrclDto, 'delete')
