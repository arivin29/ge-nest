...
@ApiTags('mpc_jo')
@Controller('mpc_jo')
export class MpcJoController {
    constructor(private readonly service: MpcJoService) { }

    @Get()
    @ApiResponseEntity(AmimsMpcJoDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcJoDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMpcJoDto }) 
    @ApiResponseEntity(AmimsMpcJoDto, 'post')
    async create(@Body() body: AmimsMpcJoDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMpcJoDto })
    @ApiResponseEntity(AmimsMpcJoDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMpcJoDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMpcJoDto, 'delete')
