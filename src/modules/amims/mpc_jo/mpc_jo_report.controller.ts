...
import { MpcJoService } from '../mpc_jo/mpc_jo.service';
...
import { AmimsMpcJoReportDto } from 'src/dto/amims/amims.mpc_jo-report.dto';;

@ApiTags('mpc_jo_report')
@Controller('mpc_jo_report')
export class MpcJoReportController {
    constructor(private readonly service: MpcJoService) { }

    @Post('list')
    @ApiResponseEntity(AmimsMpcJoReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcJoReportDto, 'get')
