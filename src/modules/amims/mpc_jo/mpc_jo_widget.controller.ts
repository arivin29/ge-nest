...
import { AmimsMpcJoWidgetDto } from 'src/dto/amims/amims.mpc_jo-widget.dto';

@ApiTags('mpc_jo_widget')
@Controller('mpc_jo_widget')
export class MpcJoWidgetController {
    constructor(private readonly service: MpcJoWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsMpcJoWidgetDto, 'list')
    async findAll(
