...
import { PartCategoryService } from '../part_category/part_category.service';
...
import { AmimsPartCategoryReportDto } from 'src/dto/amims/amims.part_category-report.dto';;

@ApiTags('part_category_report')
@Controller('part_category_report')
export class PartCategoryReportController {
    constructor(private readonly service: PartCategoryService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartCategoryReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartCategoryReportDto, 'get')
