...
@ApiTags('part_category')
@Controller('part_category')
export class PartCategoryController {
    constructor(private readonly service: PartCategoryService) { }

    @Get()
    @ApiResponseEntity(AmimsPartCategoryDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartCategoryDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartCategoryDto }) 
    @ApiResponseEntity(AmimsPartCategoryDto, 'post')
    async create(@Body() body: AmimsPartCategoryDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartCategoryDto })
    @ApiResponseEntity(AmimsPartCategoryDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartCategoryDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartCategoryDto, 'delete')
