...
import { AmimsCompanyDto } from 'src/dto/amims/amims.company.dto';; 
...
export class CompanyController {
    ...
    @Get()
    @ApiResponseEntity(AmimsCompanyDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsCompanyDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsCompanyDto }) 
    @ApiResponseEntity(AmimsCompanyDto, 'post')
    async create(@Body() body: AmimsCompanyDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsCompanyDto })
    @ApiResponseEntity(AmimsCompanyDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsCompanyDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsCompanyDto, 'delete')
