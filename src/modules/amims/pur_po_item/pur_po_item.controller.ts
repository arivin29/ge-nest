...
@ApiTags('pur_po_item')
@Controller('pur_po_item')
export class PurPoItemController {
    constructor(private readonly service: PurPoItemService) { }

    @Get()
    @ApiResponseEntity(AmimsPurPoItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurPoItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurPoItemDto }) 
    @ApiResponseEntity(AmimsPurPoItemDto, 'post')
    async create(@Body() body: AmimsPurPoItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurPoItemDto })
    @ApiResponseEntity(AmimsPurPoItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurPoItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurPoItemDto, 'delete')
