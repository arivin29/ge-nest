...
import { AmimsPurPoItemWidgetDto } from 'src/dto/amims/amims.pur_po_item-widget.dto';

@ApiTags('pur_po_item_widget')
@Controller('pur_po_item_widget')
export class PurPoItemWidgetController {
    constructor(private readonly service: PurPoItemWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPurPoItemWidgetDto, 'list')
    async findAll(
