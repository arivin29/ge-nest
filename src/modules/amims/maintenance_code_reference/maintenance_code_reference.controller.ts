...
import { AmimsMaintenanceCodeReferenceDto } from 'src/dto/amims/amims.maintenance_code_reference.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('maintenance_code_reference')
@Controller('maintenance_code_reference')
export class MaintenanceCodeReferenceController {
    constructor(private readonly service: MaintenanceCodeReferenceService) { }

    @Get()
    @ApiResponseEntity(AmimsMaintenanceCodeReferenceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceCodeReferenceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceCodeReferenceDto }) 
    @ApiResponseEntity(AmimsMaintenanceCodeReferenceDto, 'post')
    async create(@Body() body: AmimsMaintenanceCodeReferenceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceCodeReferenceDto })
    @ApiResponseEntity(AmimsMaintenanceCodeReferenceDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceCodeReferenceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceCodeReferenceDto, 'delete')
