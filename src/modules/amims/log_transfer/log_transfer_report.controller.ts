...
import { LogTransferService } from '../log_transfer/log_transfer.service';
...
import { AmimsLogTransferReportDto } from 'src/dto/amims/amims.log_transfer-report.dto';;

@ApiTags('log_transfer_report')
@Controller('log_transfer_report')
export class LogTransferReportController {
    constructor(private readonly service: LogTransferService) { }

    @Post('list')
    @ApiResponseEntity(AmimsLogTransferReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLogTransferReportDto, 'get')
