...
@ApiTags('log_transfer')
@Controller('log_transfer')
export class LogTransferController {
    constructor(private readonly service: LogTransferService) { }

    @Get()
    @ApiResponseEntity(AmimsLogTransferDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLogTransferDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLogTransferDto }) 
    @ApiResponseEntity(AmimsLogTransferDto, 'post')
    async create(@Body() body: AmimsLogTransferDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLogTransferDto })
    @ApiResponseEntity(AmimsLogTransferDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLogTransferDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLogTransferDto, 'delete')
