...
@ApiTags('qa_rpd')
@Controller('qa_rpd')
export class QaRpdController {
    constructor(private readonly service: QaRpdService) { }

    @Get()
    @ApiResponseEntity(AmimsQaRpdDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsQaRpdDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsQaRpdDto }) 
    @ApiResponseEntity(AmimsQaRpdDto, 'post')
    async create(@Body() body: AmimsQaRpdDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsQaRpdDto })
    @ApiResponseEntity(AmimsQaRpdDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsQaRpdDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsQaRpdDto, 'delete')
