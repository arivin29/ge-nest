...
@ApiTags('last_maintenance')
@Controller('last_maintenance')
export class LastMaintenanceController {
    constructor(private readonly service: LastMaintenanceService) { }

    @Get()
    @ApiResponseEntity(AmimsLastMaintenanceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLastMaintenanceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLastMaintenanceDto }) 
    @ApiResponseEntity(AmimsLastMaintenanceDto, 'post')
    async create(@Body() body: AmimsLastMaintenanceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLastMaintenanceDto })
    @ApiResponseEntity(AmimsLastMaintenanceDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLastMaintenanceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLastMaintenanceDto, 'delete')
