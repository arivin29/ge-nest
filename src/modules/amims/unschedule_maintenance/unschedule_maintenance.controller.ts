...
@ApiTags('unschedule_maintenance')
@Controller('unschedule_maintenance')
export class UnscheduleMaintenanceController {
    constructor(private readonly service: UnscheduleMaintenanceService) { }

    @Get()
    @ApiResponseEntity(AmimsUnscheduleMaintenanceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsUnscheduleMaintenanceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsUnscheduleMaintenanceDto }) 
    @ApiResponseEntity(AmimsUnscheduleMaintenanceDto, 'post')
    async create(@Body() body: AmimsUnscheduleMaintenanceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsUnscheduleMaintenanceDto })
    @ApiResponseEntity(AmimsUnscheduleMaintenanceDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsUnscheduleMaintenanceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsUnscheduleMaintenanceDto, 'delete')
