...
import { UnscheduleMaintenanceService } from '../unschedule_maintenance/unschedule_maintenance.service';
...
import { AmimsUnscheduleMaintenanceReportDto } from 'src/dto/amims/amims.unschedule_maintenance-report.dto';;

@ApiTags('unschedule_maintenance_report')
@Controller('unschedule_maintenance_report')
export class UnscheduleMaintenanceReportController {
    constructor(private readonly service: UnscheduleMaintenanceService) { }

    @Post('list')
    @ApiResponseEntity(AmimsUnscheduleMaintenanceReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsUnscheduleMaintenanceReportDto, 'get')
