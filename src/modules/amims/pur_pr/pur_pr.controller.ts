...
@ApiTags('pur_pr')
@Controller('pur_pr')
export class PurPrController {
    constructor(private readonly service: PurPrService) { }

    @Get()
    @ApiResponseEntity(AmimsPurPrDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurPrDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurPrDto }) 
    @ApiResponseEntity(AmimsPurPrDto, 'post')
    async create(@Body() body: AmimsPurPrDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurPrDto })
    @ApiResponseEntity(AmimsPurPrDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurPrDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurPrDto, 'delete')
