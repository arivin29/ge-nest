...
import { PurPrService } from '../pur_pr/pur_pr.service';
...
import { AmimsPurPrReportDto } from 'src/dto/amims/amims.pur_pr-report.dto';;

@ApiTags('pur_pr_report')
@Controller('pur_pr_report')
export class PurPrReportController {
    constructor(private readonly service: PurPrService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPurPrReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurPrReportDto, 'get')
