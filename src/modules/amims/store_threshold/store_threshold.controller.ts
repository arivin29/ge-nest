...
@ApiTags('store_threshold')
@Controller('store_threshold')
export class StoreThresholdController {
    constructor(private readonly service: StoreThresholdService) { }

    @Get()
    @ApiResponseEntity(AmimsStoreThresholdDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsStoreThresholdDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsStoreThresholdDto }) 
    @ApiResponseEntity(AmimsStoreThresholdDto, 'post')
    async create(@Body() body: AmimsStoreThresholdDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsStoreThresholdDto })
    @ApiResponseEntity(AmimsStoreThresholdDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsStoreThresholdDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsStoreThresholdDto, 'delete')
