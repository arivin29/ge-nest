...
import { StoreThresholdService } from '../store_threshold/store_threshold.service';
...
import { AmimsStoreThresholdReportDto } from 'src/dto/amims/amims.store_threshold-report.dto';;

@ApiTags('store_threshold_report')
@Controller('store_threshold_report')
export class StoreThresholdReportController {
    constructor(private readonly service: StoreThresholdService) { }

    @Post('list')
    @ApiResponseEntity(AmimsStoreThresholdReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsStoreThresholdReportDto, 'get')
