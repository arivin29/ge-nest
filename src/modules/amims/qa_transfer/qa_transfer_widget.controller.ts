...
import { AmimsQaTransferWidgetDto } from 'src/dto/amims/amims.qa_transfer-widget.dto';

@ApiTags('qa_transfer_widget')
@Controller('qa_transfer_widget')
export class QaTransferWidgetController {
    constructor(private readonly service: QaTransferWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsQaTransferWidgetDto, 'list')
    async findAll(
