...
import { QaTransferService } from '../qa_transfer/qa_transfer.service';
...
import { AmimsQaTransferReportDto } from 'src/dto/amims/amims.qa_transfer-report.dto';;

@ApiTags('qa_transfer_report')
@Controller('qa_transfer_report')
export class QaTransferReportController {
    constructor(private readonly service: QaTransferService) { }

    @Post('list')
    @ApiResponseEntity(AmimsQaTransferReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsQaTransferReportDto, 'get')
