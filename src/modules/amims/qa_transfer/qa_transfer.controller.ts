...
@ApiTags('qa_transfer')
@Controller('qa_transfer')
export class QaTransferController {
    constructor(private readonly service: QaTransferService) { }

    @Get()
    @ApiResponseEntity(AmimsQaTransferDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsQaTransferDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsQaTransferDto }) 
    @ApiResponseEntity(AmimsQaTransferDto, 'post')
    async create(@Body() body: AmimsQaTransferDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsQaTransferDto })
    @ApiResponseEntity(AmimsQaTransferDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsQaTransferDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsQaTransferDto, 'delete')
