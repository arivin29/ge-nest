...
@ApiTags('part_log')
@Controller('part_log')
export class PartLogController {
    constructor(private readonly service: PartLogService) { }

    @Get()
    @ApiResponseEntity(AmimsPartLogDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartLogDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartLogDto }) 
    @ApiResponseEntity(AmimsPartLogDto, 'post')
    async create(@Body() body: AmimsPartLogDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartLogDto })
    @ApiResponseEntity(AmimsPartLogDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartLogDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartLogDto, 'delete')
