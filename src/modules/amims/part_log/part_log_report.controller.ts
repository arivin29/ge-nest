...
import { PartLogService } from '../part_log/part_log.service';
...
import { AmimsPartLogReportDto } from 'src/dto/amims/amims.part_log-report.dto';;

@ApiTags('part_log_report')
@Controller('part_log_report')
export class PartLogReportController {
    constructor(private readonly service: PartLogService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartLogReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartLogReportDto, 'get')
