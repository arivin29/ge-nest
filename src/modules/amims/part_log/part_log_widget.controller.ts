...
import { AmimsPartLogWidgetDto } from 'src/dto/amims/amims.part_log-widget.dto';

@ApiTags('part_log_widget')
@Controller('part_log_widget')
export class PartLogWidgetController {
    constructor(private readonly service: PartLogWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPartLogWidgetDto, 'list')
    async findAll(
