...
import { AmimsMaintenanceProgramTaskDto } from 'src/dto/amims/amims.maintenance_program_task.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('maintenance_program_task')
@Controller('maintenance_program_task')
export class MaintenanceProgramTaskController {
    constructor(private readonly service: MaintenanceProgramTaskService) { }

    @Get()
    @ApiResponseEntity(AmimsMaintenanceProgramTaskDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceProgramTaskDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceProgramTaskDto }) 
    @ApiResponseEntity(AmimsMaintenanceProgramTaskDto, 'post')
    async create(@Body() body: AmimsMaintenanceProgramTaskDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceProgramTaskDto })
    @ApiResponseEntity(AmimsMaintenanceProgramTaskDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceProgramTaskDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceProgramTaskDto, 'delete')
