...
import { AmimsLogUserDto } from 'src/dto/amims/amims.log_user.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('log_user')
@Controller('log_user')
export class LogUserController {
    constructor(private readonly service: LogUserService) { }

    @Get()
    @ApiResponseEntity(AmimsLogUserDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLogUserDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLogUserDto }) 
    @ApiResponseEntity(AmimsLogUserDto, 'post')
    async create(@Body() body: AmimsLogUserDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLogUserDto })
    @ApiResponseEntity(AmimsLogUserDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLogUserDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLogUserDto, 'delete')
