...
@ApiTags('qa_transfer_item')
@Controller('qa_transfer_item')
export class QaTransferItemController {
    constructor(private readonly service: QaTransferItemService) { }

    @Get()
    @ApiResponseEntity(AmimsQaTransferItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsQaTransferItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsQaTransferItemDto }) 
    @ApiResponseEntity(AmimsQaTransferItemDto, 'post')
    async create(@Body() body: AmimsQaTransferItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsQaTransferItemDto })
    @ApiResponseEntity(AmimsQaTransferItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsQaTransferItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsQaTransferItemDto, 'delete')
