...
import { QaTransferItemService } from '../qa_transfer_item/qa_transfer_item.service';
...
import { AmimsQaTransferItemReportDto } from 'src/dto/amims/amims.qa_transfer_item-report.dto';;

@ApiTags('qa_transfer_item_report')
@Controller('qa_transfer_item_report')
export class QaTransferItemReportController {
    constructor(private readonly service: QaTransferItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsQaTransferItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'pur_prcl', type: 'single' },
                                                { name: 'qa_transfer', type: 'single' },
                                                { name: 'mpc_self_maintenance', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsQaTransferItemReportDto, 'get')
