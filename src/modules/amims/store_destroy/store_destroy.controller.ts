...
@ApiTags('store_destroy')
@Controller('store_destroy')
export class StoreDestroyController {
    constructor(private readonly service: StoreDestroyService) { }

    @Get()
    @ApiResponseEntity(AmimsStoreDestroyDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsStoreDestroyDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsStoreDestroyDto }) 
    @ApiResponseEntity(AmimsStoreDestroyDto, 'post')
    async create(@Body() body: AmimsStoreDestroyDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsStoreDestroyDto })
    @ApiResponseEntity(AmimsStoreDestroyDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsStoreDestroyDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsStoreDestroyDto, 'delete')
