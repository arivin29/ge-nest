...
@ApiTags('engineer_pmtr_item')
@Controller('engineer_pmtr_item')
export class EngineerPmtrItemController {
    constructor(private readonly service: EngineerPmtrItemService) { }

    @Get()
    @ApiResponseEntity(AmimsEngineerPmtrItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPmtrItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsEngineerPmtrItemDto }) 
    @ApiResponseEntity(AmimsEngineerPmtrItemDto, 'post')
    async create(@Body() body: AmimsEngineerPmtrItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsEngineerPmtrItemDto })
    @ApiResponseEntity(AmimsEngineerPmtrItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsEngineerPmtrItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsEngineerPmtrItemDto, 'delete')
