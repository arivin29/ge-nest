...
import { EngineerPmtrItemService } from '../engineer_pmtr_item/engineer_pmtr_item.service';
...
import { AmimsEngineerPmtrItemReportDto } from 'src/dto/amims/amims.engineer_pmtr_item-report.dto';;

@ApiTags('engineer_pmtr_item_report')
@Controller('engineer_pmtr_item_report')
export class EngineerPmtrItemReportController {
    constructor(private readonly service: EngineerPmtrItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsEngineerPmtrItemReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPmtrItemReportDto, 'get')
