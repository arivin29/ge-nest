...
import { AmimsPurPrItemWidgetDto } from 'src/dto/amims/amims.pur_pr_item-widget.dto';

@ApiTags('pur_pr_item_widget')
@Controller('pur_pr_item_widget')
export class PurPrItemWidgetController {
    constructor(private readonly service: PurPrItemWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPurPrItemWidgetDto, 'list')
    async findAll(
