...
@ApiTags('pur_pr_item')
@Controller('pur_pr_item')
export class PurPrItemController {
    constructor(private readonly service: PurPrItemService) { }

    @Get()
    @ApiResponseEntity(AmimsPurPrItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurPrItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurPrItemDto }) 
    @ApiResponseEntity(AmimsPurPrItemDto, 'post')
    async create(@Body() body: AmimsPurPrItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurPrItemDto })
    @ApiResponseEntity(AmimsPurPrItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurPrItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurPrItemDto, 'delete')
