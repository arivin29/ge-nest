...
@ApiTags('pur_return_item')
@Controller('pur_return_item')
export class PurReturnItemController {
    constructor(private readonly service: PurReturnItemService) { }

    @Get()
    @ApiResponseEntity(AmimsPurReturnItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurReturnItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurReturnItemDto }) 
    @ApiResponseEntity(AmimsPurReturnItemDto, 'post')
    async create(@Body() body: AmimsPurReturnItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurReturnItemDto })
    @ApiResponseEntity(AmimsPurReturnItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurReturnItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurReturnItemDto, 'delete')
