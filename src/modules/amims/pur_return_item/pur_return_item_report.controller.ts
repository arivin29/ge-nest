...
import { PurReturnItemService } from '../pur_return_item/pur_return_item.service';
...
import { AmimsPurReturnItemReportDto } from 'src/dto/amims/amims.pur_return_item-report.dto';;

@ApiTags('pur_return_item_report')
@Controller('pur_return_item_report')
export class PurReturnItemReportController {
    constructor(private readonly service: PurReturnItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPurReturnItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'pur_return', type: 'single' },
                                                { name: 'pur_po_item', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurReturnItemReportDto, 'get')
