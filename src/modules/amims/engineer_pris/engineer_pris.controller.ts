...
@ApiTags('engineer_pris')
@Controller('engineer_pris')
export class EngineerPrisController {
    constructor(private readonly service: EngineerPrisService) { }

    @Get()
    @ApiResponseEntity(AmimsEngineerPrisDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPrisDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsEngineerPrisDto }) 
    @ApiResponseEntity(AmimsEngineerPrisDto, 'post')
    async create(@Body() body: AmimsEngineerPrisDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsEngineerPrisDto })
    @ApiResponseEntity(AmimsEngineerPrisDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsEngineerPrisDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsEngineerPrisDto, 'delete')
