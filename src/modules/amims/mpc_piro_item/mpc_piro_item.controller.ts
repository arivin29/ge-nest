...
@ApiTags('mpc_piro_item')
@Controller('mpc_piro_item')
export class MpcPiroItemController {
    constructor(private readonly service: MpcPiroItemService) { }

    @Get()
    @ApiResponseEntity(AmimsMpcPiroItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcPiroItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMpcPiroItemDto }) 
    @ApiResponseEntity(AmimsMpcPiroItemDto, 'post')
    async create(@Body() body: AmimsMpcPiroItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMpcPiroItemDto })
    @ApiResponseEntity(AmimsMpcPiroItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMpcPiroItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMpcPiroItemDto, 'delete')
