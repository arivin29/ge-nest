...
import { LogTsnTsoService } from '../log_tsn_tso/log_tsn_tso.service';
...
import { AmimsLogTsnTsoReportDto } from 'src/dto/amims/amims.log_tsn_tso-report.dto';;

@ApiTags('log_tsn_tso_report')
@Controller('log_tsn_tso_report')
export class LogTsnTsoReportController {
    constructor(private readonly service: LogTsnTsoService) { }

    @Post('list')
    @ApiResponseEntity(AmimsLogTsnTsoReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLogTsnTsoReportDto, 'get')
