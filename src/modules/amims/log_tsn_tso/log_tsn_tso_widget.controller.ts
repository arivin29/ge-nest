...
import { AmimsLogTsnTsoWidgetDto } from 'src/dto/amims/amims.log_tsn_tso-widget.dto';

@ApiTags('log_tsn_tso_widget')
@Controller('log_tsn_tso_widget')
export class LogTsnTsoWidgetController {
    constructor(private readonly service: LogTsnTsoWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsLogTsnTsoWidgetDto, 'list')
    async findAll(
