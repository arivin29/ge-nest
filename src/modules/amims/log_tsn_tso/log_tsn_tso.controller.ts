...
@ApiTags('log_tsn_tso')
@Controller('log_tsn_tso')
export class LogTsnTsoController {
    constructor(private readonly service: LogTsnTsoService) { }

    @Get()
    @ApiResponseEntity(AmimsLogTsnTsoDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLogTsnTsoDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLogTsnTsoDto }) 
    @ApiResponseEntity(AmimsLogTsnTsoDto, 'post')
    async create(@Body() body: AmimsLogTsnTsoDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLogTsnTsoDto })
    @ApiResponseEntity(AmimsLogTsnTsoDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLogTsnTsoDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLogTsnTsoDto, 'delete')
