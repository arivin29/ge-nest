...
import { AmimsMelDto } from 'src/dto/amims/amims.mel.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('mel')
@Controller('mel')
export class MelController {
    constructor(private readonly service: MelService) { }

    @Get()
    @ApiResponseEntity(AmimsMelDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMelDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMelDto }) 
    @ApiResponseEntity(AmimsMelDto, 'post')
    async create(@Body() body: AmimsMelDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMelDto })
    @ApiResponseEntity(AmimsMelDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMelDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMelDto, 'delete')
