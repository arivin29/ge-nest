...
import { AmimsPositionReportDto } from 'src/dto/amims/amims.position-report.dto';;

@ApiTags('position_report')
@Controller('position_report')
export class PositionReportController {
    constructor(private readonly service: PositionService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPositionReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPositionReportDto, 'get')
