...
export class PositionController {
    ...
    @Get()
    @ApiResponseEntity(AmimsPositionDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPositionDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPositionDto }) 
    @ApiResponseEntity(AmimsPositionDto, 'post')
    async create(@Body() body: AmimsPositionDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPositionDto })
    @ApiResponseEntity(AmimsPositionDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPositionDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPositionDto, 'delete')
