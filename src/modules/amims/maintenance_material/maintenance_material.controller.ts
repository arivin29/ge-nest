...
import { AmimsMaintenanceMaterialDto } from 'src/dto/amims/amims.maintenance_material.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('maintenance_material')
@Controller('maintenance_material')
export class MaintenanceMaterialController {
    constructor(private readonly service: MaintenanceMaterialService) { }

    @Get()
    @ApiResponseEntity(AmimsMaintenanceMaterialDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceMaterialDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceMaterialDto }) 
    @ApiResponseEntity(AmimsMaintenanceMaterialDto, 'post')
    async create(@Body() body: AmimsMaintenanceMaterialDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceMaterialDto })
    @ApiResponseEntity(AmimsMaintenanceMaterialDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceMaterialDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceMaterialDto, 'delete')
