...
import { AmimsWarrantyDto } from 'src/dto/amims/amims.warranty.dto';; 
...
export class WarrantyController {
    ...
    @Get()
    @ApiResponseEntity(AmimsWarrantyDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsWarrantyDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsWarrantyDto }) 
    @ApiResponseEntity(AmimsWarrantyDto, 'post')
    async create(@Body() body: AmimsWarrantyDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsWarrantyDto })
    @ApiResponseEntity(AmimsWarrantyDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsWarrantyDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsWarrantyDto, 'delete')
