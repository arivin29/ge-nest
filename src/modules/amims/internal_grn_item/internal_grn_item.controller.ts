...
@ApiTags('internal_grn_item')
@Controller('internal_grn_item')
export class InternalGrnItemController {
    constructor(private readonly service: InternalGrnItemService) { }

    @Get()
    @ApiResponseEntity(AmimsInternalGrnItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsInternalGrnItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsInternalGrnItemDto }) 
    @ApiResponseEntity(AmimsInternalGrnItemDto, 'post')
    async create(@Body() body: AmimsInternalGrnItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsInternalGrnItemDto })
    @ApiResponseEntity(AmimsInternalGrnItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsInternalGrnItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsInternalGrnItemDto, 'delete')
