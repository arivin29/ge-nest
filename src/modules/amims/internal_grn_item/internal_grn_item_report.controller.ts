...
import { InternalGrnItemService } from '../internal_grn_item/internal_grn_item.service';
...
import { AmimsInternalGrnItemReportDto } from 'src/dto/amims/amims.internal_grn_item-report.dto';;

@ApiTags('internal_grn_item_report')
@Controller('internal_grn_item_report')
export class InternalGrnItemReportController {
    constructor(private readonly service: InternalGrnItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsInternalGrnItemReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsInternalGrnItemReportDto, 'get')
