...
import { AmimsDoctypeDto } from 'src/dto/amims/amims.doctype.dto';; 
...
export class DoctypeController {
    ...
    @Get()
    @ApiResponseEntity(AmimsDoctypeDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsDoctypeDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsDoctypeDto }) 
    @ApiResponseEntity(AmimsDoctypeDto, 'post')
    async create(@Body() body: AmimsDoctypeDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsDoctypeDto })
    @ApiResponseEntity(AmimsDoctypeDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsDoctypeDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsDoctypeDto, 'delete')
