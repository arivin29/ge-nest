...
import { PurGrnService } from '../pur_grn/pur_grn.service';
...
import { AmimsPurGrnReportDto } from 'src/dto/amims/amims.pur_grn-report.dto';;

@ApiTags('pur_grn_report')
@Controller('pur_grn_report')
export class PurGrnReportController {
    constructor(private readonly service: PurGrnService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPurGrnReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurGrnReportDto, 'get')
