...
import { AmimsPurGrnWidgetDto } from 'src/dto/amims/amims.pur_grn-widget.dto';

@ApiTags('pur_grn_widget')
@Controller('pur_grn_widget')
export class PurGrnWidgetController {
    constructor(private readonly service: PurGrnWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPurGrnWidgetDto, 'list')
    async findAll(
