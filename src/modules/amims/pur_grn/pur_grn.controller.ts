...
@ApiTags('pur_grn')
@Controller('pur_grn')
export class PurGrnController {
    constructor(private readonly service: PurGrnService) { }

    @Get()
    @ApiResponseEntity(AmimsPurGrnDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurGrnDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurGrnDto }) 
    @ApiResponseEntity(AmimsPurGrnDto, 'post')
    async create(@Body() body: AmimsPurGrnDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurGrnDto })
    @ApiResponseEntity(AmimsPurGrnDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurGrnDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurGrnDto, 'delete')
