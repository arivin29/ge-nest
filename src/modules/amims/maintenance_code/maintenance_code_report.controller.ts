...
import { MaintenanceCodeService } from '../maintenance_code/maintenance_code.service';
...
import { AmimsMaintenanceCodeReportDto } from 'src/dto/amims/amims.maintenance_code-report.dto';;

@ApiTags('maintenance_code_report')
@Controller('maintenance_code_report')
export class MaintenanceCodeReportController {
    constructor(private readonly service: MaintenanceCodeService) { }

    @Post('list')
    @ApiResponseEntity(AmimsMaintenanceCodeReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceCodeReportDto, 'get')
