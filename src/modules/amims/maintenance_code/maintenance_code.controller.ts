...
@ApiTags('maintenance_code')
@Controller('maintenance_code')
export class MaintenanceCodeController {
    constructor(private readonly service: MaintenanceCodeService) { }

    @Get()
    @ApiResponseEntity(AmimsMaintenanceCodeDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceCodeDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceCodeDto }) 
    @ApiResponseEntity(AmimsMaintenanceCodeDto, 'post')
    async create(@Body() body: AmimsMaintenanceCodeDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceCodeDto })
    @ApiResponseEntity(AmimsMaintenanceCodeDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceCodeDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceCodeDto, 'delete')
