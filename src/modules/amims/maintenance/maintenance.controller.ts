...
import { AmimsMaintenanceDto } from 'src/dto/amims/amims.maintenance.dto';; 
...
export class MaintenanceController {
    ...
    @Get()
    @ApiResponseEntity(AmimsMaintenanceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceDto }) 
    @ApiResponseEntity(AmimsMaintenanceDto, 'post')
    async create(@Body() body: AmimsMaintenanceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceDto })
    @ApiResponseEntity(AmimsMaintenanceDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceDto, 'delete')
