...
import { AmimsMaintenanceReportDto } from 'src/dto/amims/amims.maintenance-report.dto';;

@ApiTags('maintenance_report')
@Controller('maintenance_report')
export class MaintenanceReportController {
    constructor(private readonly service: MaintenanceService) { }

    @Post('list')
    @ApiResponseEntity(AmimsMaintenanceReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceReportDto, 'get')
