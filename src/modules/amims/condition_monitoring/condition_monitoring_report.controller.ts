...
import { ConditionMonitoringService } from '../condition_monitoring/condition_monitoring.service';
...
import { AmimsConditionMonitoringReportDto } from 'src/dto/amims/amims.condition_monitoring-report.dto';;

@ApiTags('condition_monitoring_report')
@Controller('condition_monitoring_report')
export class ConditionMonitoringReportController {
    constructor(private readonly service: ConditionMonitoringService) { }

    @Post('list')
    @ApiResponseEntity(AmimsConditionMonitoringReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsConditionMonitoringReportDto, 'get')
