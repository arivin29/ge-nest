...
@ApiTags('condition_monitoring')
@Controller('condition_monitoring')
export class ConditionMonitoringController {
    constructor(private readonly service: ConditionMonitoringService) { }

    @Get()
    @ApiResponseEntity(AmimsConditionMonitoringDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsConditionMonitoringDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsConditionMonitoringDto }) 
    @ApiResponseEntity(AmimsConditionMonitoringDto, 'post')
    async create(@Body() body: AmimsConditionMonitoringDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsConditionMonitoringDto })
    @ApiResponseEntity(AmimsConditionMonitoringDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsConditionMonitoringDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsConditionMonitoringDto, 'delete')
