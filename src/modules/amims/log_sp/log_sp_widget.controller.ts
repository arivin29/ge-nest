...
import { AmimsLogSpWidgetDto } from 'src/dto/amims/amims.log_sp-widget.dto';

@ApiTags('log_sp_widget')
@Controller('log_sp_widget')
export class LogSpWidgetController {
    constructor(private readonly service: LogSpWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsLogSpWidgetDto, 'list')
    async findAll(
