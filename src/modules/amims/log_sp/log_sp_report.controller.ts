...
import { LogSpService } from '../log_sp/log_sp.service';
...
import { AmimsLogSpReportDto } from 'src/dto/amims/amims.log_sp-report.dto';;

@ApiTags('log_sp_report')
@Controller('log_sp_report')
export class LogSpReportController {
    constructor(private readonly service: LogSpService) { }

    @Post('list')
    @ApiResponseEntity(AmimsLogSpReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLogSpReportDto, 'get')
