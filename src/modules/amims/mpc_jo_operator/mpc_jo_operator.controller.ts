...
@ApiTags('mpc_jo_operator')
@Controller('mpc_jo_operator')
export class MpcJoOperatorController {
    constructor(private readonly service: MpcJoOperatorService) { }

    @Get()
    @ApiResponseEntity(AmimsMpcJoOperatorDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcJoOperatorDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMpcJoOperatorDto }) 
    @ApiResponseEntity(AmimsMpcJoOperatorDto, 'post')
    async create(@Body() body: AmimsMpcJoOperatorDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMpcJoOperatorDto })
    @ApiResponseEntity(AmimsMpcJoOperatorDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMpcJoOperatorDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMpcJoOperatorDto, 'delete')
