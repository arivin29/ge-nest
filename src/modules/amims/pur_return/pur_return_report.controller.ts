...
import { PurReturnService } from '../pur_return/pur_return.service';
...
import { AmimsPurReturnReportDto } from 'src/dto/amims/amims.pur_return-report.dto';;

@ApiTags('pur_return_report')
@Controller('pur_return_report')
export class PurReturnReportController {
    constructor(private readonly service: PurReturnService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPurReturnReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurReturnReportDto, 'get')
