...
@ApiTags('pur_return')
@Controller('pur_return')
export class PurReturnController {
    constructor(private readonly service: PurReturnService) { }

    @Get()
    @ApiResponseEntity(AmimsPurReturnDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurReturnDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurReturnDto }) 
    @ApiResponseEntity(AmimsPurReturnDto, 'post')
    async create(@Body() body: AmimsPurReturnDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurReturnDto })
    @ApiResponseEntity(AmimsPurReturnDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurReturnDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurReturnDto, 'delete')
