...
import { AmimsPurReturnWidgetDto } from 'src/dto/amims/amims.pur_return-widget.dto';

@ApiTags('pur_return_widget')
@Controller('pur_return_widget')
export class PurReturnWidgetController {
    constructor(private readonly service: PurReturnWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPurReturnWidgetDto, 'list')
    async findAll(
