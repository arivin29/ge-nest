...
export class StoreTransferController {
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsStoreTransferDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsStoreTransferDto }) 
    @ApiResponseEntity(AmimsStoreTransferDto, 'post')
    async create(@Body() body: AmimsStoreTransferDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsStoreTransferDto })
    @ApiResponseEntity(AmimsStoreTransferDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsStoreTransferDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsStoreTransferDto, 'delete')
