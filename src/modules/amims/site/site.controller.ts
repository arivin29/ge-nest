...
export class SiteController {
    ...
    @Get()
    @ApiResponseEntity(AmimsSiteDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsSiteDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsSiteDto }) 
    @ApiResponseEntity(AmimsSiteDto, 'post')
    async create(@Body() body: AmimsSiteDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsSiteDto })
    @ApiResponseEntity(AmimsSiteDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsSiteDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsSiteDto, 'delete')
