...
import { AmimsLibReferenceDto } from 'src/dto/amims/amims.lib_reference.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('lib_reference')
@Controller('lib_reference')
export class LibReferenceController {
    constructor(private readonly service: LibReferenceService) { }

    @Get()
    @ApiResponseEntity(AmimsLibReferenceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLibReferenceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLibReferenceDto }) 
    @ApiResponseEntity(AmimsLibReferenceDto, 'post')
    async create(@Body() body: AmimsLibReferenceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLibReferenceDto })
    @ApiResponseEntity(AmimsLibReferenceDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLibReferenceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLibReferenceDto, 'delete')
