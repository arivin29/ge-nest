...
import { AmimsMcurrencyDto } from 'src/dto/amims/amims.mcurrency.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('mcurrency')
@Controller('mcurrency')
export class McurrencyController {
    constructor(private readonly service: McurrencyService) { }

    @Get()
    @ApiResponseEntity(AmimsMcurrencyDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMcurrencyDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMcurrencyDto }) 
    @ApiResponseEntity(AmimsMcurrencyDto, 'post')
    async create(@Body() body: AmimsMcurrencyDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMcurrencyDto })
    @ApiResponseEntity(AmimsMcurrencyDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMcurrencyDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMcurrencyDto, 'delete')
