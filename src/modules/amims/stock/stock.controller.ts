...
export class StockController {
    ...
    @Get()
    @ApiResponseEntity(AmimsStockDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsStockDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsStockDto }) 
    @ApiResponseEntity(AmimsStockDto, 'post')
    async create(@Body() body: AmimsStockDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsStockDto })
    @ApiResponseEntity(AmimsStockDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsStockDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsStockDto, 'delete')
