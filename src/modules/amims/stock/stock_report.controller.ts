...
import { AmimsStockReportDto } from 'src/dto/amims/amims.stock-report.dto';;

@ApiTags('stock_report')
@Controller('stock_report')
export class StockReportController {
    constructor(private readonly service: StockService) { }

    @Post('list')
    @ApiResponseEntity(AmimsStockReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsStockReportDto, 'get')
