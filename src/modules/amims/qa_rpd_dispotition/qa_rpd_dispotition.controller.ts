...
@ApiTags('qa_rpd_dispotition')
@Controller('qa_rpd_dispotition')
export class QaRpdDispotitionController {
    constructor(private readonly service: QaRpdDispotitionService) { }

    @Get()
    @ApiResponseEntity(AmimsQaRpdDispotitionDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsQaRpdDispotitionDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsQaRpdDispotitionDto }) 
    @ApiResponseEntity(AmimsQaRpdDispotitionDto, 'post')
    async create(@Body() body: AmimsQaRpdDispotitionDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsQaRpdDispotitionDto })
    @ApiResponseEntity(AmimsQaRpdDispotitionDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsQaRpdDispotitionDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsQaRpdDispotitionDto, 'delete')
