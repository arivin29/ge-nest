...
import { QaRpdDispotitionService } from '../qa_rpd_dispotition/qa_rpd_dispotition.service';
...
import { AmimsQaRpdDispotitionReportDto } from 'src/dto/amims/amims.qa_rpd_dispotition-report.dto';;

@ApiTags('qa_rpd_dispotition_report')
@Controller('qa_rpd_dispotition_report')
export class QaRpdDispotitionReportController {
    constructor(private readonly service: QaRpdDispotitionService) { }

    @Post('list')
    @ApiResponseEntity(AmimsQaRpdDispotitionReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsQaRpdDispotitionReportDto, 'get')
