...
import { AmimsPurPoWidgetDto } from 'src/dto/amims/amims.pur_po-widget.dto';

@ApiTags('pur_po_widget')
@Controller('pur_po_widget')
export class PurPoWidgetController {
    constructor(private readonly service: PurPoWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPurPoWidgetDto, 'list')
    async findAll(
