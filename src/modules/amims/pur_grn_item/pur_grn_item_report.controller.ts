...
import { PurGrnItemService } from '../pur_grn_item/pur_grn_item.service';
...
import { AmimsPurGrnItemReportDto } from 'src/dto/amims/amims.pur_grn_item-report.dto';;

@ApiTags('pur_grn_item_report')
@Controller('pur_grn_item_report')
export class PurGrnItemReportController {
    constructor(private readonly service: PurGrnItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPurGrnItemReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurGrnItemReportDto, 'get')
