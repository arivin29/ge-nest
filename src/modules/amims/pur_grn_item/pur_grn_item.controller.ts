...
@ApiTags('pur_grn_item')
@Controller('pur_grn_item')
export class PurGrnItemController {
    constructor(private readonly service: PurGrnItemService) { }

    @Get()
    @ApiResponseEntity(AmimsPurGrnItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurGrnItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurGrnItemDto }) 
    @ApiResponseEntity(AmimsPurGrnItemDto, 'post')
    async create(@Body() body: AmimsPurGrnItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurGrnItemDto })
    @ApiResponseEntity(AmimsPurGrnItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurGrnItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurGrnItemDto, 'delete')
