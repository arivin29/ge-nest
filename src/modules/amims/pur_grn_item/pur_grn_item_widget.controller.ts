...
import { AmimsPurGrnItemWidgetDto } from 'src/dto/amims/amims.pur_grn_item-widget.dto';

@ApiTags('pur_grn_item_widget')
@Controller('pur_grn_item_widget')
export class PurGrnItemWidgetController {
    constructor(private readonly service: PurGrnItemWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsPurGrnItemWidgetDto, 'list')
    async findAll(
