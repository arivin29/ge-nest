...
import { PartActypeService } from '../part_actype/part_actype.service';
...
import { AmimsPartActypeReportDto } from 'src/dto/amims/amims.part_actype-report.dto';;

@ApiTags('part_actype_report')
@Controller('part_actype_report')
export class PartActypeReportController {
    constructor(private readonly service: PartActypeService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartActypeReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartActypeReportDto, 'get')
