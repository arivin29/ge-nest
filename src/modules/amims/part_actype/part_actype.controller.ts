...
@ApiTags('part_actype')
@Controller('part_actype')
export class PartActypeController {
    constructor(private readonly service: PartActypeService) { }

    @Get()
    @ApiResponseEntity(AmimsPartActypeDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartActypeDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartActypeDto }) 
    @ApiResponseEntity(AmimsPartActypeDto, 'post')
    async create(@Body() body: AmimsPartActypeDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartActypeDto })
    @ApiResponseEntity(AmimsPartActypeDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartActypeDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartActypeDto, 'delete')
