...
@ApiTags('mpc_gse')
@Controller('mpc_gse')
export class MpcGseController {
    constructor(private readonly service: MpcGseService) { }

    @Get()
    @ApiResponseEntity(AmimsMpcGseDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcGseDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMpcGseDto }) 
    @ApiResponseEntity(AmimsMpcGseDto, 'post')
    async create(@Body() body: AmimsMpcGseDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMpcGseDto })
    @ApiResponseEntity(AmimsMpcGseDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMpcGseDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMpcGseDto, 'delete')
