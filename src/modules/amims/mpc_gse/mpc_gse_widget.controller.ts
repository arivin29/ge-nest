...
import { AmimsMpcGseWidgetDto } from 'src/dto/amims/amims.mpc_gse-widget.dto';

@ApiTags('mpc_gse_widget')
@Controller('mpc_gse_widget')
export class MpcGseWidgetController {
    constructor(private readonly service: MpcGseWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsMpcGseWidgetDto, 'list')
    async findAll(
