...
import { MpcGseService } from '../mpc_gse/mpc_gse.service';
...
import { AmimsMpcGseReportDto } from 'src/dto/amims/amims.mpc_gse-report.dto';;

@ApiTags('mpc_gse_report')
@Controller('mpc_gse_report')
export class MpcGseReportController {
    constructor(private readonly service: MpcGseService) { }

    @Post('list')
    @ApiResponseEntity(AmimsMpcGseReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcGseReportDto, 'get')
