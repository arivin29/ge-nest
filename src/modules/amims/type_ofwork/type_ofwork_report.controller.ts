...
import { TypeOfworkService } from '../type_ofwork/type_ofwork.service';
...
import { AmimsTypeOfworkReportDto } from 'src/dto/amims/amims.type_ofwork-report.dto';;

@ApiTags('type_ofwork_report')
@Controller('type_ofwork_report')
export class TypeOfworkReportController {
    constructor(private readonly service: TypeOfworkService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTypeOfworkReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTypeOfworkReportDto, 'get')
