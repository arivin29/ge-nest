...
import { AmimsTypeOfworkDto } from 'src/dto/amims/amims.type_ofwork.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('type_ofwork')
@Controller('type_ofwork')
export class TypeOfworkController {
    constructor(private readonly service: TypeOfworkService) { }

    @Get()
    @ApiResponseEntity(AmimsTypeOfworkDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTypeOfworkDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTypeOfworkDto }) 
    @ApiResponseEntity(AmimsTypeOfworkDto, 'post')
    async create(@Body() body: AmimsTypeOfworkDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTypeOfworkDto })
    @ApiResponseEntity(AmimsTypeOfworkDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTypeOfworkDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTypeOfworkDto, 'delete')
