...
import { AmimsFigureIndexDto } from 'src/dto/amims/amims.figure_index.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('figure_index')
@Controller('figure_index')
export class FigureIndexController {
    constructor(private readonly service: FigureIndexService) { }

    @Get()
    @ApiResponseEntity(AmimsFigureIndexDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsFigureIndexDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsFigureIndexDto }) 
    @ApiResponseEntity(AmimsFigureIndexDto, 'post')
    async create(@Body() body: AmimsFigureIndexDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsFigureIndexDto })
    @ApiResponseEntity(AmimsFigureIndexDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsFigureIndexDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsFigureIndexDto, 'delete')
