...
import { AmimsLifeTimeLimitDto } from 'src/dto/amims/amims.life_time_limit.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('life_time_limit')
@Controller('life_time_limit')
export class LifeTimeLimitController {
    constructor(private readonly service: LifeTimeLimitService) { }

    @Get()
    @ApiResponseEntity(AmimsLifeTimeLimitDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLifeTimeLimitDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsLifeTimeLimitDto }) 
    @ApiResponseEntity(AmimsLifeTimeLimitDto, 'post')
    async create(@Body() body: AmimsLifeTimeLimitDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsLifeTimeLimitDto })
    @ApiResponseEntity(AmimsLifeTimeLimitDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsLifeTimeLimitDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsLifeTimeLimitDto, 'delete')
