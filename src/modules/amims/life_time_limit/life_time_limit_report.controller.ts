...
import { LifeTimeLimitService } from '../life_time_limit/life_time_limit.service';
...
import { AmimsLifeTimeLimitReportDto } from 'src/dto/amims/amims.life_time_limit-report.dto';;

@ApiTags('life_time_limit_report')
@Controller('life_time_limit_report')
export class LifeTimeLimitReportController {
    constructor(private readonly service: LifeTimeLimitService) { }

    @Post('list')
    @ApiResponseEntity(AmimsLifeTimeLimitReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsLifeTimeLimitReportDto, 'get')
