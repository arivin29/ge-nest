...
import { AmimsAtaDto } from 'src/dto/amims/amims.ata.dto';; 
...
export class AtaController {
    ...
    @Get()
    @ApiResponseEntity(AmimsAtaDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsAtaDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsAtaDto }) 
    @ApiResponseEntity(AmimsAtaDto, 'post')
    async create(@Body() body: AmimsAtaDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsAtaDto })
    @ApiResponseEntity(AmimsAtaDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsAtaDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsAtaDto, 'delete')
