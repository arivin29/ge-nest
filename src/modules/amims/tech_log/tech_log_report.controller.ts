...
import { TechLogService } from '../tech_log/tech_log.service';
...
@Controller('tech_log_report')
export class TechLogReportController {
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechLogReportDto, 'get')
