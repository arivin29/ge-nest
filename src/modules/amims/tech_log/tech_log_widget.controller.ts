...
import { AmimsTechLogWidgetDto } from 'src/dto/amims/amims.tech_log-widget.dto';

@ApiTags('tech_log_widget')
@Controller('tech_log_widget')
export class TechLogWidgetController {
    constructor(private readonly service: TechLogWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsTechLogWidgetDto, 'list')
    async findAll(
