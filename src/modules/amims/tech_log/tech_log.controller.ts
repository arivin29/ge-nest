...
export class TechLogController {
    ...
    @Get()
    @ApiResponseEntity(AmimsTechLogDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechLogDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTechLogDto }) 
    @ApiResponseEntity(AmimsTechLogDto, 'post')
    async create(@Body() body: AmimsTechLogDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTechLogDto })
    @ApiResponseEntity(AmimsTechLogDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTechLogDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTechLogDto, 'delete')
