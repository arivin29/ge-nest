...
import { EngineerPmtrService } from '../engineer_pmtr/engineer_pmtr.service';
...
import { AmimsEngineerPmtrReportDto } from 'src/dto/amims/amims.engineer_pmtr-report.dto';;

@ApiTags('engineer_pmtr_report')
@Controller('engineer_pmtr_report')
export class EngineerPmtrReportController {
    constructor(private readonly service: EngineerPmtrService) { }

    @Post('list')
    @ApiResponseEntity(AmimsEngineerPmtrReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPmtrReportDto, 'get')
