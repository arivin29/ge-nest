...
@ApiTags('engineer_pmtr')
@Controller('engineer_pmtr')
export class EngineerPmtrController {
    constructor(private readonly service: EngineerPmtrService) { }

    @Get()
    @ApiResponseEntity(AmimsEngineerPmtrDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsEngineerPmtrDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsEngineerPmtrDto }) 
    @ApiResponseEntity(AmimsEngineerPmtrDto, 'post')
    async create(@Body() body: AmimsEngineerPmtrDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsEngineerPmtrDto })
    @ApiResponseEntity(AmimsEngineerPmtrDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsEngineerPmtrDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsEngineerPmtrDto, 'delete')
