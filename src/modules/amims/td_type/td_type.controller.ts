...
@ApiTags('td_type')
@Controller('td_type')
export class TdTypeController {
    constructor(private readonly service: TdTypeService) { }

    @Get()
    @ApiResponseEntity(AmimsTdTypeDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTdTypeDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTdTypeDto }) 
    @ApiResponseEntity(AmimsTdTypeDto, 'post')
    async create(@Body() body: AmimsTdTypeDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTdTypeDto })
    @ApiResponseEntity(AmimsTdTypeDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTdTypeDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTdTypeDto, 'delete')
