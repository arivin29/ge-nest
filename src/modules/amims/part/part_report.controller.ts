...
import { AmimsPartReportDto } from 'src/dto/amims/amims.part-report.dto';;

@ApiTags('part_report')
@Controller('part_report')
export class PartReportController {
    constructor(private readonly service: PartService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartReportDto, 'get')
