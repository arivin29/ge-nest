...
export class PartController {
    ...
    @Get()
    @ApiResponseEntity(AmimsPartDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartDto }) 
    @ApiResponseEntity(AmimsPartDto, 'post')
    async create(@Body() body: AmimsPartDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartDto })
    @ApiResponseEntity(AmimsPartDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartDto, 'delete')
