...
@ApiTags('tech_defect')
@Controller('tech_defect')
export class TechDefectController {
    constructor(private readonly service: TechDefectService) { }

    @Get()
    @ApiResponseEntity(AmimsTechDefectDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechDefectDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTechDefectDto }) 
    @ApiResponseEntity(AmimsTechDefectDto, 'post')
    async create(@Body() body: AmimsTechDefectDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTechDefectDto })
    @ApiResponseEntity(AmimsTechDefectDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTechDefectDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTechDefectDto, 'delete')
