...
import { TechDefectService } from '../tech_defect/tech_defect.service';
...
import { AmimsTechDefectReportDto } from 'src/dto/amims/amims.tech_defect-report.dto';;

@ApiTags('tech_defect_report')
@Controller('tech_defect_report')
export class TechDefectReportController {
    constructor(private readonly service: TechDefectService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTechDefectReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechDefectReportDto, 'get')
