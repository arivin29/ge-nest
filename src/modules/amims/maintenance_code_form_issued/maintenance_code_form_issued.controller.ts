...
import { AmimsMaintenanceCodeFormIssuedDto } from 'src/dto/amims/amims.maintenance_code_form_issued.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('maintenance_code_form_issued')
@Controller('maintenance_code_form_issued')
export class MaintenanceCodeFormIssuedController {
    constructor(private readonly service: MaintenanceCodeFormIssuedService) { }

    @Get()
    @ApiResponseEntity(AmimsMaintenanceCodeFormIssuedDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceCodeFormIssuedDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceCodeFormIssuedDto }) 
    @ApiResponseEntity(AmimsMaintenanceCodeFormIssuedDto, 'post')
    async create(@Body() body: AmimsMaintenanceCodeFormIssuedDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceCodeFormIssuedDto })
    @ApiResponseEntity(AmimsMaintenanceCodeFormIssuedDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceCodeFormIssuedDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceCodeFormIssuedDto, 'delete')
