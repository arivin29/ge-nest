...
import { AmimsMaintenanceDocumentDto } from 'src/dto/amims/amims.maintenance_document.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('maintenance_document')
@Controller('maintenance_document')
export class MaintenanceDocumentController {
    constructor(private readonly service: MaintenanceDocumentService) { }

    @Get()
    @ApiResponseEntity(AmimsMaintenanceDocumentDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMaintenanceDocumentDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMaintenanceDocumentDto }) 
    @ApiResponseEntity(AmimsMaintenanceDocumentDto, 'post')
    async create(@Body() body: AmimsMaintenanceDocumentDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMaintenanceDocumentDto })
    @ApiResponseEntity(AmimsMaintenanceDocumentDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMaintenanceDocumentDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMaintenanceDocumentDto, 'delete')
