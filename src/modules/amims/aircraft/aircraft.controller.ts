...
export class AircraftController {
    constructor(private readonly service: AircraftService) { }

    @Get()
    @ApiResponseEntity(AmimsAircraftDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsAircraftDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsAircraftDto }) 
    @ApiResponseEntity(AmimsAircraftDto, 'post')
    async create(@Body() body: AmimsAircraftDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsAircraftDto })
    @ApiResponseEntity(AmimsAircraftDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsAircraftDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsAircraftDto, 'delete')
