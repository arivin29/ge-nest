...
import { AmimsAircraftWidgetDto } from 'src/dto/amims/amims.aircraft-widget.dto';

@ApiTags('aircraft_widget')
@Controller('aircraft_widget')
export class AircraftWidgetController {
    constructor(private readonly service: AircraftWidgetService) { }

    @Post() 
    @ApiResponseEntity( AmimsAircraftWidgetDto, 'list')
    async findAll(
