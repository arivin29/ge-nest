...
import { AmimsAircraftReportDto } from 'src/dto/amims/amims.aircraft-report.dto';;

@ApiTags('aircraft_report')
@Controller('aircraft_report')
export class AircraftReportController {
    constructor(private readonly service: AircraftService) { }

    @Post('list')
    @ApiResponseEntity(AmimsAircraftReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsAircraftReportDto, 'get')
