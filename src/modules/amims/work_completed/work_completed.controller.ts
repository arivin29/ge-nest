...
@ApiTags('work_completed')
@Controller('work_completed')
export class WorkCompletedController {
    constructor(private readonly service: WorkCompletedService) { }

    @Get()
    @ApiResponseEntity(AmimsWorkCompletedDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsWorkCompletedDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsWorkCompletedDto }) 
    @ApiResponseEntity(AmimsWorkCompletedDto, 'post')
    async create(@Body() body: AmimsWorkCompletedDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsWorkCompletedDto })
    @ApiResponseEntity(AmimsWorkCompletedDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsWorkCompletedDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsWorkCompletedDto, 'delete')
