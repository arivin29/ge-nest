...
@ApiTags('tech_log_item')
@Controller('tech_log_item')
export class TechLogItemController {
    constructor(private readonly service: TechLogItemService) { }

    @Get()
    @ApiResponseEntity(AmimsTechLogItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechLogItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTechLogItemDto }) 
    @ApiResponseEntity(AmimsTechLogItemDto, 'post')
    async create(@Body() body: AmimsTechLogItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTechLogItemDto })
    @ApiResponseEntity(AmimsTechLogItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTechLogItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTechLogItemDto, 'delete')
