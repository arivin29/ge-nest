...
import { AmimsInspectionReportDto } from 'src/dto/amims/amims.inspection-report.dto';;

@ApiTags('inspection_report')
@Controller('inspection_report')
export class InspectionReportController {
    constructor(private readonly service: InspectionService) { }

    @Post('list')
    @ApiResponseEntity(AmimsInspectionReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsInspectionReportDto, 'get')
