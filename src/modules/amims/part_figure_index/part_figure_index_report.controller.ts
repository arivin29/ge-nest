...
import { PartFigureIndexService } from '../part_figure_index/part_figure_index.service';
...
import { AmimsPartFigureIndexReportDto } from 'src/dto/amims/amims.part_figure_index-report.dto';;

@ApiTags('part_figure_index_report')
@Controller('part_figure_index_report')
export class PartFigureIndexReportController {
    constructor(private readonly service: PartFigureIndexService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartFigureIndexReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartFigureIndexReportDto, 'get')
