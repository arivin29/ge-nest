...
@ApiTags('part_figure_index')
@Controller('part_figure_index')
export class PartFigureIndexController {
    constructor(private readonly service: PartFigureIndexService) { }

    @Get()
    @ApiResponseEntity(AmimsPartFigureIndexDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartFigureIndexDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartFigureIndexDto }) 
    @ApiResponseEntity(AmimsPartFigureIndexDto, 'post')
    async create(@Body() body: AmimsPartFigureIndexDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartFigureIndexDto })
    @ApiResponseEntity(AmimsPartFigureIndexDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartFigureIndexDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartFigureIndexDto, 'delete')
