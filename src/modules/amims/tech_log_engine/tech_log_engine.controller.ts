...
@ApiTags('tech_log_engine')
@Controller('tech_log_engine')
export class TechLogEngineController {
    constructor(private readonly service: TechLogEngineService) { }

    @Get()
    @ApiResponseEntity(AmimsTechLogEngineDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechLogEngineDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsTechLogEngineDto }) 
    @ApiResponseEntity(AmimsTechLogEngineDto, 'post')
    async create(@Body() body: AmimsTechLogEngineDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsTechLogEngineDto })
    @ApiResponseEntity(AmimsTechLogEngineDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsTechLogEngineDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsTechLogEngineDto, 'delete')
