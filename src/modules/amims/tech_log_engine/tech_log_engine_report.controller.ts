...
import { TechLogEngineService } from '../tech_log_engine/tech_log_engine.service';
...
import { AmimsTechLogEngineReportDto } from 'src/dto/amims/amims.tech_log_engine-report.dto';;

@ApiTags('tech_log_engine_report')
@Controller('tech_log_engine_report')
export class TechLogEngineReportController {
    constructor(private readonly service: TechLogEngineService) { }

    @Post('list')
    @ApiResponseEntity(AmimsTechLogEngineReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsTechLogEngineReportDto, 'get')
