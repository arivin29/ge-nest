...
@ApiTags('part_install')
@Controller('part_install')
export class PartInstallController {
    constructor(private readonly service: PartInstallService) { }

    @Get()
    @ApiResponseEntity(AmimsPartInstallDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartInstallDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPartInstallDto }) 
    @ApiResponseEntity(AmimsPartInstallDto, 'post')
    async create(@Body() body: AmimsPartInstallDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPartInstallDto })
    @ApiResponseEntity(AmimsPartInstallDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPartInstallDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPartInstallDto, 'delete')
