...
import { PartInstallService } from '../part_install/part_install.service';
...
import { AmimsPartInstallReportDto } from 'src/dto/amims/amims.part_install-report.dto';;

@ApiTags('part_install_report')
@Controller('part_install_report')
export class PartInstallReportController {
    constructor(private readonly service: PartInstallService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPartInstallReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPartInstallReportDto, 'get')
