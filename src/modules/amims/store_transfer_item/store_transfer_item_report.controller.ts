...
import { StoreTransferItemService } from '../store_transfer_item/store_transfer_item.service';
...
import { AmimsStoreTransferItemReportDto } from 'src/dto/amims/amims.store_transfer_item-report.dto';;

@ApiTags('store_transfer_item_report')
@Controller('store_transfer_item_report')
export class StoreTransferItemReportController {
    constructor(private readonly service: StoreTransferItemService) { }

    @Post('list')
    @ApiResponseEntity(AmimsStoreTransferItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                ...
                                                { name: 'store_transfer', type: 'single' },
                                                { name: 'engineer_pmtr_item', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsStoreTransferItemReportDto, 'get')
