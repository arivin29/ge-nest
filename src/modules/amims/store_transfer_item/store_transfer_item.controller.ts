...
@ApiTags('store_transfer_item')
@Controller('store_transfer_item')
export class StoreTransferItemController {
    constructor(private readonly service: StoreTransferItemService) { }

    @Get()
    @ApiResponseEntity(AmimsStoreTransferItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsStoreTransferItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsStoreTransferItemDto }) 
    @ApiResponseEntity(AmimsStoreTransferItemDto, 'post')
    async create(@Body() body: AmimsStoreTransferItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsStoreTransferItemDto })
    @ApiResponseEntity(AmimsStoreTransferItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsStoreTransferItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsStoreTransferItemDto, 'delete')
