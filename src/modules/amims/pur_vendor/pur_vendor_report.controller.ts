...
import { PurVendorService } from '../pur_vendor/pur_vendor.service';
...
import { AmimsPurVendorReportDto } from 'src/dto/amims/amims.pur_vendor-report.dto';;

@ApiTags('pur_vendor_report')
@Controller('pur_vendor_report')
export class PurVendorReportController {
    constructor(private readonly service: PurVendorService) { }

    @Post('list')
    @ApiResponseEntity(AmimsPurVendorReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurVendorReportDto, 'get')
