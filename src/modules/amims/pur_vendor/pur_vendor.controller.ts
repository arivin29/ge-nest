...
@ApiTags('pur_vendor')
@Controller('pur_vendor')
export class PurVendorController {
    constructor(private readonly service: PurVendorService) { }

    @Get()
    @ApiResponseEntity(AmimsPurVendorDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsPurVendorDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsPurVendorDto }) 
    @ApiResponseEntity(AmimsPurVendorDto, 'post')
    async create(@Body() body: AmimsPurVendorDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsPurVendorDto })
    @ApiResponseEntity(AmimsPurVendorDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsPurVendorDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsPurVendorDto, 'delete')
