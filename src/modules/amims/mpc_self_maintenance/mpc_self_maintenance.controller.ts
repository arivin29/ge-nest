...
@ApiTags('mpc_self_maintenance')
@Controller('mpc_self_maintenance')
export class MpcSelfMaintenanceController {
    constructor(private readonly service: MpcSelfMaintenanceService) { }

    @Get()
    @ApiResponseEntity(AmimsMpcSelfMaintenanceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AmimsMpcSelfMaintenanceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AmimsMpcSelfMaintenanceDto }) 
    @ApiResponseEntity(AmimsMpcSelfMaintenanceDto, 'post')
    async create(@Body() body: AmimsMpcSelfMaintenanceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AmimsMpcSelfMaintenanceDto })
    @ApiResponseEntity(AmimsMpcSelfMaintenanceDto, 'put')
    async update(@Param('id') id: string, @Body() body: AmimsMpcSelfMaintenanceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AmimsMpcSelfMaintenanceDto, 'delete')
