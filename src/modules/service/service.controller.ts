...
export class ServiceController {
    ...
    @Get()
    @ApiResponseEntity(ServiceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ServiceDto, 'get')
    ...
    @ApiResponseEntity(ServiceDto, 'post')
    async create(@Body() body: ServiceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ServiceDto })
    @ApiResponseEntity(ServiceDto, 'put')
    async update(@Param('id') id: string, @Body() body: ServiceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ServiceDto, 'delete')
