...
import { ClientSiteDto } from './dto/client_site.dto'; 
...
export class ClientSiteController {
    ...
    @Get()
    @ApiResponseEntity(ClientSiteDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ClientSiteDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ClientSiteDto }) 
    @ApiResponseEntity(ClientSiteDto, 'post')
    async create(@Body() body: ClientSiteDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ClientSiteDto })
    @ApiResponseEntity(ClientSiteDto, 'put')
    async update(@Param('id') id: string, @Body() body: ClientSiteDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ClientSiteDto, 'delete')
