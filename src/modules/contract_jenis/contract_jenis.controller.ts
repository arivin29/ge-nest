...
import { ContractJenisDto } from './dto/contract_jenis.dto'; 
...
export class ContractJenisController {
    ...
    @Get()
    @ApiResponseEntity(ContractJenisDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ContractJenisDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ContractJenisDto }) 
    @ApiResponseEntity(ContractJenisDto, 'post')
    async create(@Body() body: ContractJenisDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ContractJenisDto })
    @ApiResponseEntity(ContractJenisDto, 'put')
    async update(@Param('id') id: string, @Body() body: ContractJenisDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ContractJenisDto, 'delete')
