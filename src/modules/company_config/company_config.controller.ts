...
import { CompanyConfigDto } from './dto/company_config.dto'; 
...
export class CompanyConfigController {
    ...
    @Get()
    @ApiResponseEntity(CompanyConfigDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(CompanyConfigDto, 'get')
    ...
    @Post()
    @ApiBody({ type: CompanyConfigDto }) 
    @ApiResponseEntity(CompanyConfigDto, 'post')
    async create(@Body() body: CompanyConfigDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: CompanyConfigDto })
    @ApiResponseEntity(CompanyConfigDto, 'put')
    async update(@Param('id') id: string, @Body() body: CompanyConfigDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(CompanyConfigDto, 'delete')
