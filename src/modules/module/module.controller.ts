...
export class ModuleController {
    ...
    @Get()
    @ApiResponseEntity(ModuleDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ModuleDto, 'get')
    ...
    @ApiResponseEntity(ModuleDto, 'post')
    async create(@Body() body: ModuleDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ModuleDto })
    @ApiResponseEntity(ModuleDto, 'put')
    async update(@Param('id') id: string, @Body() body: ModuleDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ModuleDto, 'delete')
