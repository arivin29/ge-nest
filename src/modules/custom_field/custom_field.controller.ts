...
export class CustomFieldController {
    ...
    @Get()
    @ApiResponseEntity(CustomFieldDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(CustomFieldDto, 'get')
    ...
    @ApiResponseEntity(CustomFieldDto, 'post')
    async create(@Body() body: CustomFieldDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: CustomFieldDto })
    @ApiResponseEntity(CustomFieldDto, 'put')
    async update(@Param('id') id: string, @Body() body: CustomFieldDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(CustomFieldDto, 'delete')
