...
export class InvoiceController {
    ...
    @Get()
    @ApiResponseEntity(InvoiceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(InvoiceDto, 'get')
    ...
    @ApiResponseEntity(InvoiceDto, 'post')
    async create(@Body() body: InvoiceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: InvoiceDto })
    @ApiResponseEntity(InvoiceDto, 'put')
    async update(@Param('id') id: string, @Body() body: InvoiceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(InvoiceDto, 'delete')
