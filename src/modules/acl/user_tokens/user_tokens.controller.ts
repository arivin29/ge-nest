...
import { AclUserTokensDto } from 'src/dto/acl/acl.user_tokens.dto';; 
...
export class UserTokensController {
    ...
    @Get()
    @ApiResponseEntity(AclUserTokensDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(AclUserTokensDto, 'get')
    ...
    @Post()
    @ApiBody({ type: AclUserTokensDto }) 
    @ApiResponseEntity(AclUserTokensDto, 'post')
    async create(@Body() body: AclUserTokensDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: AclUserTokensDto })
    @ApiResponseEntity(AclUserTokensDto, 'put')
    async update(@Param('id') id: string, @Body() body: AclUserTokensDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(AclUserTokensDto, 'delete')
