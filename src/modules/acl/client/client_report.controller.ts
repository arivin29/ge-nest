...
import { PelangganClientReportDto } from 'src/dto/pelanggan/pelanggan.client-report.dto';;

@ApiTags('client_report')
@Controller('client_report')
export class ClientReportController {
    constructor(private readonly service: ClientService) { }

    @Post('list')
    @ApiResponseEntity(PelangganClientReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganClientReportDto, 'get')
