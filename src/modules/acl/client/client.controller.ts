...
export class ClientController {
    ...
    @Get()
    @ApiResponseEntity(PelangganClientDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganClientDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganClientDto }) 
    @ApiResponseEntity(PelangganClientDto, 'post')
    async create(@Body() body: PelangganClientDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganClientDto })
    @ApiResponseEntity(PelangganClientDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganClientDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganClientDto, 'delete')
