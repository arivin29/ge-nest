...
@ApiTags('document_numbering')
@Controller('document_numbering')
export class DocumentNumberingController {
    constructor(private readonly service: DocumentNumberingService) { }

    @Get()
    @ApiResponseEntity(ToolsDocumentNumberingDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ToolsDocumentNumberingDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ToolsDocumentNumberingDto }) 
    @ApiResponseEntity(ToolsDocumentNumberingDto, 'post')
    async create(@Body() body: ToolsDocumentNumberingDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ToolsDocumentNumberingDto })
    @ApiResponseEntity(ToolsDocumentNumberingDto, 'put')
    async update(@Param('id') id: string, @Body() body: ToolsDocumentNumberingDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ToolsDocumentNumberingDto, 'delete')
