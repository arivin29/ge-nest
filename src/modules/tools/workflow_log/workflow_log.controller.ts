...
export class WorkflowLogController {
    ...
    @Get(':id')
    @ApiResponseEntity(ToolsWorkflowLogDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ToolsWorkflowLogDto }) 
    @ApiResponseEntity(ToolsWorkflowLogDto, 'post')
    async create(@Body() body: ToolsWorkflowLogDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ToolsWorkflowLogDto })
    @ApiResponseEntity(ToolsWorkflowLogDto, 'put')
    async update(@Param('id') id: string, @Body() body: ToolsWorkflowLogDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ToolsWorkflowLogDto, 'delete')
