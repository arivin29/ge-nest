...
import { ToolsDocumentNumberingCounterDto } from 'src/dto/tools/tools.document_numbering_counter.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('document_numbering_counter')
@Controller('document_numbering_counter')
export class DocumentNumberingCounterController {
    constructor(private readonly service: DocumentNumberingCounterService) { }

    @Get()
    @ApiResponseEntity(ToolsDocumentNumberingCounterDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ToolsDocumentNumberingCounterDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ToolsDocumentNumberingCounterDto }) 
    @ApiResponseEntity(ToolsDocumentNumberingCounterDto, 'post')
    async create(@Body() body: ToolsDocumentNumberingCounterDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ToolsDocumentNumberingCounterDto })
    @ApiResponseEntity(ToolsDocumentNumberingCounterDto, 'put')
    async update(@Param('id') id: string, @Body() body: ToolsDocumentNumberingCounterDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ToolsDocumentNumberingCounterDto, 'delete')
