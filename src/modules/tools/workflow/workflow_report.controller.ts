...
import { ToolsWorkflowReportDto } from 'src/dto/tools/tools.workflow-report.dto';;

@ApiTags('workflow_report')
@Controller('workflow_report')
export class WorkflowReportController {
    constructor(private readonly service: WorkflowService) { }

    @Post('list')
    @ApiResponseEntity(ToolsWorkflowReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(ToolsWorkflowReportDto, 'get')
