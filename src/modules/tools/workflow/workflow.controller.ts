...
export class WorkflowController {
    ...
    @Get()
    @ApiResponseEntity(ToolsWorkflowDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ToolsWorkflowDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ToolsWorkflowDto }) 
    @ApiResponseEntity(ToolsWorkflowDto, 'post')
    async create(@Body() body: ToolsWorkflowDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ToolsWorkflowDto })
    @ApiResponseEntity(ToolsWorkflowDto, 'put')
    async update(@Param('id') id: string, @Body() body: ToolsWorkflowDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ToolsWorkflowDto, 'delete')
