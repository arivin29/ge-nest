...
@ApiTags('workflow_step')
@Controller('workflow_step')
export class WorkflowStepController {
    constructor(private readonly service: WorkflowStepService) { }

    @Get()
    @ApiResponseEntity(ToolsWorkflowStepDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ToolsWorkflowStepDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ToolsWorkflowStepDto }) 
    @ApiResponseEntity(ToolsWorkflowStepDto, 'post')
    async create(@Body() body: ToolsWorkflowStepDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ToolsWorkflowStepDto })
    @ApiResponseEntity(ToolsWorkflowStepDto, 'put')
    async update(@Param('id') id: string, @Body() body: ToolsWorkflowStepDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ToolsWorkflowStepDto, 'delete')
