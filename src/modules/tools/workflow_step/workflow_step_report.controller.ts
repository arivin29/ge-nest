...
import { WorkflowStepService } from '../workflow_step/workflow_step.service';
...
import { ToolsWorkflowStepReportDto } from 'src/dto/tools/tools.workflow_step-report.dto';;

@ApiTags('workflow_step_report')
@Controller('workflow_step_report')
export class WorkflowStepReportController {
    constructor(private readonly service: WorkflowStepService) { }

    @Post('list')
    @ApiResponseEntity(ToolsWorkflowStepReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(ToolsWorkflowStepReportDto, 'get')
