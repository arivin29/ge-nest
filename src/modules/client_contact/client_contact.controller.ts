...
import { ClientContactDto } from './dto/client_contact.dto'; 
...
export class ClientContactController {
    ...
    @Get()
    @ApiResponseEntity(ClientContactDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ClientContactDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ClientContactDto }) 
    @ApiResponseEntity(ClientContactDto, 'post')
    async create(@Body() body: ClientContactDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ClientContactDto })
    @ApiResponseEntity(ClientContactDto, 'put')
    async update(@Param('id') id: string, @Body() body: ClientContactDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ClientContactDto, 'delete')
