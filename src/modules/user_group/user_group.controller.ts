...
import { UserGroupDto } from './dto/user_group.dto'; 
...
export class UserGroupController {
    ...
    @Get()
    @ApiResponseEntity(UserGroupDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(UserGroupDto, 'get')
    ...
    @ApiResponseEntity(UserGroupDto, 'post')
    ...
    @Put(':id')
    @ApiBody({ type: UserGroupDto })
    @ApiResponseEntity(UserGroupDto, 'put')
    async update(@Param('id') id: string, @Body() body: UserGroupDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(UserGroupDto, 'delete')
