...
import { WorkScheduleDto } from './dto/work_schedule.dto'; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('work_schedule')
@Controller('work_schedule')
export class WorkScheduleController {
    constructor(private readonly service: WorkScheduleService) { }

    @Get()
    @ApiResponseEntity(WorkScheduleDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(WorkScheduleDto, 'get')
    ...
    @ApiResponseEntity(WorkScheduleDto, 'post')
    async create(@Body() body: WorkScheduleDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: WorkScheduleDto })
    @ApiResponseEntity(WorkScheduleDto, 'put')
    async update(@Param('id') id: string, @Body() body: WorkScheduleDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(WorkScheduleDto, 'delete')
