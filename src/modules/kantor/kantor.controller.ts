...
import { KantorDto } from './dto/kantor.dto'; 
...
export class KantorController {
    ...
    @Get()
    @ApiResponseEntity(KantorDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(KantorDto, 'get')
    ...
    @Post()
    @ApiBody({ type: KantorDto }) 
    @ApiResponseEntity(KantorDto, 'post')
    async create(@Body() body: KantorDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: KantorDto })
    @ApiResponseEntity(KantorDto, 'put')
    async update(@Param('id') id: string, @Body() body: KantorDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(KantorDto, 'delete')
