...
import { ContractSiteServiceDto } from './dto/contract_site_service.dto'; 
...
export class ContractSiteServiceController {
    ...
    @Get()
    @ApiResponseEntity(ContractSiteServiceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ContractSiteServiceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: ContractSiteServiceDto }) 
    @ApiResponseEntity(ContractSiteServiceDto, 'post')
    async create(@Body() body: ContractSiteServiceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: ContractSiteServiceDto })
    @ApiResponseEntity(ContractSiteServiceDto, 'put')
    async update(@Param('id') id: string, @Body() body: ContractSiteServiceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(ContractSiteServiceDto, 'delete')
