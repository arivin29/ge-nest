...
import { CustomFieldValueDto } from './dto/custom_field_value.dto'; 
...
export class CustomFieldValueController {
    ...
    @Get()
    @ApiResponseEntity(CustomFieldValueDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(CustomFieldValueDto, 'get')
    ...
    @ApiResponseEntity(CustomFieldValueDto, 'post')
    async create(@Body() body: CustomFieldValueDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: CustomFieldValueDto })
    @ApiResponseEntity(CustomFieldValueDto, 'put')
    async update(@Param('id') id: string, @Body() body: CustomFieldValueDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(CustomFieldValueDto, 'delete')
