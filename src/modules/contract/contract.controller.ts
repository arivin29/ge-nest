...
export class ContractController {
    ...
    @Get()
    @ApiResponseEntity(ContractDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(ContractDto, 'get')
    ...
    @ApiResponseEntity(ContractDto, 'post')
    ...
    @Put(':id')
    @ApiBody({ type: ContractDto })
    @ApiResponseEntity(ContractDto, 'put')
    ...
    @Delete(':id')
    @ApiResponseEntity(ContractDto, 'delete')
