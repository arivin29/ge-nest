...
import { UserGroupAccessDto } from './dto/user_group_access.dto'; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('user_group_access')
@Controller('user_group_access')
export class UserGroupAccessController {
    constructor(private readonly service: UserGroupAccessService) { }

    @Get()
    @ApiResponseEntity(UserGroupAccessDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(UserGroupAccessDto, 'get')
    ...
    @Post()
    @ApiBody({ type: UserGroupAccessDto }) 
    @ApiResponseEntity(UserGroupAccessDto, 'post')
    ...
    @Put(':id')
    @ApiBody({ type: UserGroupAccessDto })
    @ApiResponseEntity(UserGroupAccessDto, 'put')
    ...
    @Delete(':id')
    @ApiResponseEntity(UserGroupAccessDto, 'delete')
