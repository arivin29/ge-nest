...
@ApiTags('work_schedule_teknisi')
@Controller('work_schedule_teknisi')
export class WorkScheduleTeknisiController {
    constructor(private readonly service: WorkScheduleTeknisiService) { }

    @Get()
    @ApiResponseEntity(PelangganWorkScheduleTeknisiDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganWorkScheduleTeknisiDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganWorkScheduleTeknisiDto }) 
    @ApiResponseEntity(PelangganWorkScheduleTeknisiDto, 'post')
    async create(@Body() body: PelangganWorkScheduleTeknisiDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganWorkScheduleTeknisiDto })
    @ApiResponseEntity(PelangganWorkScheduleTeknisiDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganWorkScheduleTeknisiDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganWorkScheduleTeknisiDto, 'delete')
