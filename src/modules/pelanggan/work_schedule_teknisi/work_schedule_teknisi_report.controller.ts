...
import { WorkScheduleTeknisiService } from '../work_schedule_teknisi/work_schedule_teknisi.service';
...
import { PelangganWorkScheduleTeknisiReportDto } from 'src/dto/pelanggan/pelanggan.work_schedule_teknisi-report.dto';;

@ApiTags('work_schedule_teknisi_report')
@Controller('work_schedule_teknisi_report')
export class WorkScheduleTeknisiReportController {
    constructor(private readonly service: WorkScheduleTeknisiService) { }

    @Post('list')
    @ApiResponseEntity(PelangganWorkScheduleTeknisiReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganWorkScheduleTeknisiReportDto, 'get')
