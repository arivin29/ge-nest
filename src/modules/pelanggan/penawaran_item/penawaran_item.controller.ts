...
import { PelangganPenawaranItemDto } from 'src/dto/pelanggan/pelanggan.penawaran_item.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('penawaran_item')
@Controller('penawaran_item')
export class PenawaranItemController {
    constructor(private readonly service: PenawaranItemService) { }

    @Get()
    @ApiResponseEntity(PelangganPenawaranItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPenawaranItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPenawaranItemDto }) 
    @ApiResponseEntity(PelangganPenawaranItemDto, 'post')
    async create(@Body() body: PelangganPenawaranItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPenawaranItemDto })
    @ApiResponseEntity(PelangganPenawaranItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPenawaranItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPenawaranItemDto, 'delete')
