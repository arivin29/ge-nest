...
import { PelangganContractReportDto } from 'src/dto/pelanggan/pelanggan.contract-report.dto';;
...
export class ContractReportController {
    ...
    @Post('list')
    @ApiResponseEntity(PelangganContractReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                ...
                                                { name: 'contract_jenis', type: 'single' },
                                                { name: 'kantor', type: 'single' },
                                                { name: 'document', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContractReportDto, 'get')
