...
export class ContractController {
    ...
    @Get()
    @ApiResponseEntity(PelangganContractDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContractDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganContractDto }) 
    @ApiResponseEntity(PelangganContractDto, 'post')
    async create(@Body() body: PelangganContractDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganContractDto })
    @ApiResponseEntity(PelangganContractDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganContractDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganContractDto, 'delete')
