...
import { InvoiceItemService } from '../invoice_item/invoice_item.service';
...
import { PelangganInvoiceItemReportDto } from 'src/dto/pelanggan/pelanggan.invoice_item-report.dto';;

@ApiTags('invoice_item_report')
@Controller('invoice_item_report')
export class InvoiceItemReportController {
    constructor(private readonly service: InvoiceItemService) { }

    @Post('list')
    @ApiResponseEntity(PelangganInvoiceItemReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganInvoiceItemReportDto, 'get')
