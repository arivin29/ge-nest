...
export class InvoiceItemController {
    ...
    @Get()
    @ApiResponseEntity(PelangganInvoiceItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganInvoiceItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganInvoiceItemDto }) 
    @ApiResponseEntity(PelangganInvoiceItemDto, 'post')
    async create(@Body() body: PelangganInvoiceItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganInvoiceItemDto })
    @ApiResponseEntity(PelangganInvoiceItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganInvoiceItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganInvoiceItemDto, 'delete')
