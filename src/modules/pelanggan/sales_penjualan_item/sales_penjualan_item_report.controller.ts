...
import { SalesPenjualanItemService } from '../sales_penjualan_item/sales_penjualan_item.service';
...
import { PelangganSalesPenjualanItemReportDto } from 'src/dto/pelanggan/pelanggan.sales_penjualan_item-report.dto';;

@ApiTags('sales_penjualan_item_report')
@Controller('sales_penjualan_item_report')
export class SalesPenjualanItemReportController {
    constructor(private readonly service: SalesPenjualanItemService) { }

    @Post('list')
    @ApiResponseEntity(PelangganSalesPenjualanItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'sales_barang', type: 'single' },
                                                { name: 'sales_penjualan', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSalesPenjualanItemReportDto, 'get')
