...
@ApiTags('sales_penjualan_item')
@Controller('sales_penjualan_item')
export class SalesPenjualanItemController {
    constructor(private readonly service: SalesPenjualanItemService) { }

    @Get()
    @ApiResponseEntity(PelangganSalesPenjualanItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSalesPenjualanItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganSalesPenjualanItemDto }) 
    @ApiResponseEntity(PelangganSalesPenjualanItemDto, 'post')
    async create(@Body() body: PelangganSalesPenjualanItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganSalesPenjualanItemDto })
    @ApiResponseEntity(PelangganSalesPenjualanItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganSalesPenjualanItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganSalesPenjualanItemDto, 'delete')
