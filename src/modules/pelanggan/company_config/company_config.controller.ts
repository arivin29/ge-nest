...
@ApiTags('company_config')
@Controller('company_config')
export class CompanyConfigController {
    constructor(private readonly service: CompanyConfigService) { }

    @Get()
    @ApiResponseEntity(PelangganCompanyConfigDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganCompanyConfigDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganCompanyConfigDto }) 
    @ApiResponseEntity(PelangganCompanyConfigDto, 'post')
    async create(@Body() body: PelangganCompanyConfigDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganCompanyConfigDto })
    @ApiResponseEntity(PelangganCompanyConfigDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganCompanyConfigDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganCompanyConfigDto, 'delete')
