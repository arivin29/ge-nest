...
import { PelangganBankAccountReportDto } from 'src/dto/pelanggan/pelanggan.bank_account-report.dto';;

@ApiTags('bank_account_report')
@Controller('bank_account_report')
export class BankAccountReportController {
    constructor(private readonly service: BankAccountService) { }

    @Post('list')
    @ApiResponseEntity(PelangganBankAccountReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganBankAccountReportDto, 'get')
