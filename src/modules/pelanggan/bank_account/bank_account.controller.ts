...
export class BankAccountController {
    ...
    @Get()
    @ApiResponseEntity(PelangganBankAccountDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganBankAccountDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganBankAccountDto }) 
    @ApiResponseEntity(PelangganBankAccountDto, 'post')
    async create(@Body() body: PelangganBankAccountDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganBankAccountDto })
    @ApiResponseEntity(PelangganBankAccountDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganBankAccountDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganBankAccountDto, 'delete')
