...
import { SaleShippingItemService } from '../sale_shipping_item/sale_shipping_item.service';
...
import { PelangganSaleShippingItemReportDto } from 'src/dto/pelanggan/pelanggan.sale_shipping_item-report.dto';;

@ApiTags('sale_shipping_item_report')
@Controller('sale_shipping_item_report')
export class SaleShippingItemReportController {
    constructor(private readonly service: SaleShippingItemService) { }

    @Post('list')
    @ApiResponseEntity(PelangganSaleShippingItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'sale_shipping', type: 'single' },
                                                { name: 'sales_penjualan_item', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSaleShippingItemReportDto, 'get')
