...
@ApiTags('sale_shipping_item')
@Controller('sale_shipping_item')
export class SaleShippingItemController {
    constructor(private readonly service: SaleShippingItemService) { }

    @Get()
    @ApiResponseEntity(PelangganSaleShippingItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSaleShippingItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganSaleShippingItemDto }) 
    @ApiResponseEntity(PelangganSaleShippingItemDto, 'post')
    async create(@Body() body: PelangganSaleShippingItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganSaleShippingItemDto })
    @ApiResponseEntity(PelangganSaleShippingItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganSaleShippingItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganSaleShippingItemDto, 'delete')
