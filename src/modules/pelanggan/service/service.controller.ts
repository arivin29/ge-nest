...
export class ServiceController {
    ...
    @Get()
    @ApiResponseEntity(PelangganServiceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganServiceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganServiceDto }) 
    @ApiResponseEntity(PelangganServiceDto, 'post')
    async create(@Body() body: PelangganServiceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganServiceDto })
    @ApiResponseEntity(PelangganServiceDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganServiceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganServiceDto, 'delete')
