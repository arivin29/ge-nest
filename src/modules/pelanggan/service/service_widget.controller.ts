...
import { PelangganServiceWidgetDto } from 'src/dto/pelanggan/pelanggan.service-widget.dto';

@ApiTags('service_widget')
@Controller('service_widget')
export class ServiceWidgetController {
    constructor(private readonly service: ServiceWidgetService) { }

    @Post() 
    @ApiResponseEntity( PelangganServiceWidgetDto, 'list')
    async findAll(
