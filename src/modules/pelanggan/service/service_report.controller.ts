...
import { PelangganServiceReportDto } from 'src/dto/pelanggan/pelanggan.service-report.dto';;

@ApiTags('service_report')
@Controller('service_report')
export class ServiceReportController {
    constructor(private readonly service: ServiceService) { }

    @Post('list')
    @ApiResponseEntity(PelangganServiceReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganServiceReportDto, 'get')
