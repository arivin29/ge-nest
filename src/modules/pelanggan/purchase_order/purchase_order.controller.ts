...
@ApiTags('purchase_order')
@Controller('purchase_order')
export class PurchaseOrderController {
    constructor(private readonly service: PurchaseOrderService) { }

    @Get()
    @ApiResponseEntity(PelangganPurchaseOrderDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPurchaseOrderDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPurchaseOrderDto }) 
    @ApiResponseEntity(PelangganPurchaseOrderDto, 'post')
    async create(@Body() body: PelangganPurchaseOrderDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPurchaseOrderDto })
    @ApiResponseEntity(PelangganPurchaseOrderDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPurchaseOrderDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPurchaseOrderDto, 'delete')
