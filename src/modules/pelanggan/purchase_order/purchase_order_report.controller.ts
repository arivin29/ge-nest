...
import { PurchaseOrderService } from '../purchase_order/purchase_order.service';
...
import { PelangganPurchaseOrderReportDto } from 'src/dto/pelanggan/pelanggan.purchase_order-report.dto';;

@ApiTags('purchase_order_report')
@Controller('purchase_order_report')
export class PurchaseOrderReportController {
    constructor(private readonly service: PurchaseOrderService) { }

    @Post('list')
    @ApiResponseEntity(PelangganPurchaseOrderReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPurchaseOrderReportDto, 'get')
