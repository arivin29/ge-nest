...
@ApiTags('purchase_order_item')
@Controller('purchase_order_item')
export class PurchaseOrderItemController {
    constructor(private readonly service: PurchaseOrderItemService) { }

    @Get()
    @ApiResponseEntity(PelangganPurchaseOrderItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPurchaseOrderItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPurchaseOrderItemDto }) 
    @ApiResponseEntity(PelangganPurchaseOrderItemDto, 'post')
    async create(@Body() body: PelangganPurchaseOrderItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPurchaseOrderItemDto })
    @ApiResponseEntity(PelangganPurchaseOrderItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPurchaseOrderItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPurchaseOrderItemDto, 'delete')
