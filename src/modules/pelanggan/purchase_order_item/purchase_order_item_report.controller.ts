...
import { PurchaseOrderItemService } from '../purchase_order_item/purchase_order_item.service';
...
import { PelangganPurchaseOrderItemReportDto } from 'src/dto/pelanggan/pelanggan.purchase_order_item-report.dto';;

@ApiTags('purchase_order_item_report')
@Controller('purchase_order_item_report')
export class PurchaseOrderItemReportController {
    constructor(private readonly service: PurchaseOrderItemService) { }

    @Post('list')
    @ApiResponseEntity(PelangganPurchaseOrderItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                ...
                                                { name: 'purchase_order', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPurchaseOrderItemReportDto, 'get')
