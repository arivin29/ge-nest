...
import { PurchaseInvoiceItemService } from '../purchase_invoice_item/purchase_invoice_item.service';
...
import { PelangganPurchaseInvoiceItemReportDto } from 'src/dto/pelanggan/pelanggan.purchase_invoice_item-report.dto';;

@ApiTags('purchase_invoice_item_report')
@Controller('purchase_invoice_item_report')
export class PurchaseInvoiceItemReportController {
    constructor(private readonly service: PurchaseInvoiceItemService) { }

    @Post('list')
    @ApiResponseEntity(PelangganPurchaseInvoiceItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'produk', type: 'single' },
                                                { name: 'purchase_invoice', type: 'single' },
                                                { name: 'purchase_order_item', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPurchaseInvoiceItemReportDto, 'get')
