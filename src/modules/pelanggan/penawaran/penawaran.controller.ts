...
export class PenawaranController {
    ...
    @Get()
    @ApiResponseEntity(PelangganPenawaranDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPenawaranDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPenawaranDto }) 
    @ApiResponseEntity(PelangganPenawaranDto, 'post')
    async create(@Body() body: PelangganPenawaranDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPenawaranDto })
    @ApiResponseEntity(PelangganPenawaranDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPenawaranDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPenawaranDto, 'delete')
