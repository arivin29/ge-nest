...
import { PenawaranService } from '../penawaran/penawaran.service';
...
import { PelangganPenawaranReportDto } from 'src/dto/pelanggan/pelanggan.penawaran-report.dto';;

@ApiTags('penawaran_report')
@Controller('penawaran_report')
export class PenawaranReportController {
    constructor(private readonly service: PenawaranService) { }

    @Post('list')
    @ApiResponseEntity(PelangganPenawaranReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                ...
                                                { name: 'kantor', type: 'single' },
                                                { name: 'penawaran_asal', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPenawaranReportDto, 'get')
