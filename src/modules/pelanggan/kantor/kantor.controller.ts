...
export class KantorController {
    constructor(private readonly service: KantorService) { }

    @Get()
    @ApiResponseEntity(PelangganKantorDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganKantorDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganKantorDto }) 
    @ApiResponseEntity(PelangganKantorDto, 'post')
    async create(@Body() body: PelangganKantorDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganKantorDto })
    @ApiResponseEntity(PelangganKantorDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganKantorDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganKantorDto, 'delete')
