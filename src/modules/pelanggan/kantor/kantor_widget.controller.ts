...
import { PelangganKantorWidgetDto } from 'src/dto/pelanggan/pelanggan.kantor-widget.dto';

@ApiTags('kantor_widget')
@Controller('kantor_widget')
export class KantorWidgetController {
    constructor(private readonly service: KantorWidgetService) { }

    @Post() 
    @ApiResponseEntity( PelangganKantorWidgetDto, 'list')
    async findAll(
