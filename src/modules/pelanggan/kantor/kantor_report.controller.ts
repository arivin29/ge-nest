...
import { KantorService } from '../kantor/kantor.service';
...
import { PelangganKantorReportDto } from 'src/dto/pelanggan/pelanggan.kantor-report.dto';;

@ApiTags('kantor_report')
@Controller('kantor_report')
export class KantorReportController {
    constructor(private readonly service: KantorService) { }

    @Post('list')
    @ApiResponseEntity(PelangganKantorReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganKantorReportDto, 'get')
