...
@ApiTags('work_schedule_bap_item')
@Controller('work_schedule_bap_item')
export class WorkScheduleBapItemController {
    constructor(private readonly service: WorkScheduleBapItemService) { }

    @Get()
    @ApiResponseEntity(PelangganWorkScheduleBapItemDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganWorkScheduleBapItemDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganWorkScheduleBapItemDto }) 
    @ApiResponseEntity(PelangganWorkScheduleBapItemDto, 'post')
    async create(@Body() body: PelangganWorkScheduleBapItemDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganWorkScheduleBapItemDto })
    @ApiResponseEntity(PelangganWorkScheduleBapItemDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganWorkScheduleBapItemDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganWorkScheduleBapItemDto, 'delete')
