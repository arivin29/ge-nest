...
import { WorkScheduleBapItemService } from '../work_schedule_bap_item/work_schedule_bap_item.service';
...
import { PelangganWorkScheduleBapItemReportDto } from 'src/dto/pelanggan/pelanggan.work_schedule_bap_item-report.dto';;

@ApiTags('work_schedule_bap_item_report')
@Controller('work_schedule_bap_item_report')
export class WorkScheduleBapItemReportController {
    constructor(private readonly service: WorkScheduleBapItemService) { }

    @Post('list')
    @ApiResponseEntity(PelangganWorkScheduleBapItemReportDto, 'list') 
    async findAll( 
        ...
        const parsed: SmartQueryInput = {
            ...
            include: (source as any).include ?? [
                                                { name: 'work_schedule_bap', type: 'single' },
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganWorkScheduleBapItemReportDto, 'get')
