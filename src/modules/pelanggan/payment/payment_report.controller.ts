...
import { PelangganPaymentReportDto } from 'src/dto/pelanggan/pelanggan.payment-report.dto';;

@ApiTags('payment_report')
@Controller('payment_report')
export class PaymentReportController {
    constructor(private readonly service: PaymentService) { }

    @Post('list')
    @ApiResponseEntity(PelangganPaymentReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPaymentReportDto, 'get')
