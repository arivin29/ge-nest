...
export class PaymentController {
    ...
    @Get()
    @ApiResponseEntity(PelangganPaymentDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPaymentDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPaymentDto }) 
    @ApiResponseEntity(PelangganPaymentDto, 'post')
    async create(@Body() body: PelangganPaymentDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPaymentDto })
    @ApiResponseEntity(PelangganPaymentDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPaymentDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPaymentDto, 'delete')
