...
export class WorkScheduleController {
    ...
    @Get()
    @ApiResponseEntity(PelangganWorkScheduleDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganWorkScheduleDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganWorkScheduleDto }) 
    @ApiResponseEntity(PelangganWorkScheduleDto, 'post')
    async create(@Body() body: PelangganWorkScheduleDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganWorkScheduleDto })
    @ApiResponseEntity(PelangganWorkScheduleDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganWorkScheduleDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganWorkScheduleDto, 'delete')
