...
import { PurchaseInvoiceService } from '../purchase_invoice/purchase_invoice.service';
...
import { PelangganPurchaseInvoiceReportDto } from 'src/dto/pelanggan/pelanggan.purchase_invoice-report.dto';;

@ApiTags('purchase_invoice_report')
@Controller('purchase_invoice_report')
export class PurchaseInvoiceReportController {
    constructor(private readonly service: PurchaseInvoiceService) { }

    @Post('list')
    @ApiResponseEntity(PelangganPurchaseInvoiceReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPurchaseInvoiceReportDto, 'get')
