...
export class PurchaseInvoiceController {
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPurchaseInvoiceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPurchaseInvoiceDto }) 
    @ApiResponseEntity(PelangganPurchaseInvoiceDto, 'post')
    async create(@Body() body: PelangganPurchaseInvoiceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPurchaseInvoiceDto })
    @ApiResponseEntity(PelangganPurchaseInvoiceDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPurchaseInvoiceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPurchaseInvoiceDto, 'delete')
