...
export class TeknisiController {
    constructor(private readonly service: TeknisiService) { }

    @Get()
    @ApiResponseEntity(PelangganTeknisiDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganTeknisiDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganTeknisiDto }) 
    @ApiResponseEntity(PelangganTeknisiDto, 'post')
    async create(@Body() body: PelangganTeknisiDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganTeknisiDto })
    @ApiResponseEntity(PelangganTeknisiDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganTeknisiDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganTeknisiDto, 'delete')
