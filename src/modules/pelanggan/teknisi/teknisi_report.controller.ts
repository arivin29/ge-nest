...
import { TeknisiService } from '../teknisi/teknisi.service';
...
import { PelangganTeknisiReportDto } from 'src/dto/pelanggan/pelanggan.teknisi-report.dto';;

@ApiTags('teknisi_report')
@Controller('teknisi_report')
export class TeknisiReportController {
    constructor(private readonly service: TeknisiService) { }

    @Post('list')
    @ApiResponseEntity(PelangganTeknisiReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganTeknisiReportDto, 'get')
