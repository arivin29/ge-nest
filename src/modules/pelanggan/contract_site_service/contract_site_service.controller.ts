...
@ApiTags('contract_site_service')
@Controller('contract_site_service')
export class ContractSiteServiceController {
    constructor(private readonly service: ContractSiteServiceService) { }

    @Get()
    @ApiResponseEntity(PelangganContractSiteServiceDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContractSiteServiceDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganContractSiteServiceDto }) 
    @ApiResponseEntity(PelangganContractSiteServiceDto, 'post')
    async create(@Body() body: PelangganContractSiteServiceDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganContractSiteServiceDto })
    @ApiResponseEntity(PelangganContractSiteServiceDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganContractSiteServiceDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganContractSiteServiceDto, 'delete')
