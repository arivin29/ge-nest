...
import { ContractSiteServiceService } from '../contract_site_service/contract_site_service.service';
...
import { PelangganContractSiteServiceReportDto } from 'src/dto/pelanggan/pelanggan.contract_site_service-report.dto';;

@ApiTags('contract_site_service_report')
@Controller('contract_site_service_report')
export class ContractSiteServiceReportController {
    constructor(private readonly service: ContractSiteServiceService) { }

    @Post('list')
    @ApiResponseEntity(PelangganContractSiteServiceReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContractSiteServiceReportDto, 'get')
