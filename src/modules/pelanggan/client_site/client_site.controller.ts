...
@ApiTags('client_site')
@Controller('client_site')
export class ClientSiteController {
    constructor(private readonly service: ClientSiteService) { }

    @Get()
    @ApiResponseEntity(PelangganClientSiteDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganClientSiteDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganClientSiteDto }) 
    @ApiResponseEntity(PelangganClientSiteDto, 'post')
    async create(@Body() body: PelangganClientSiteDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganClientSiteDto })
    @ApiResponseEntity(PelangganClientSiteDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganClientSiteDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganClientSiteDto, 'delete')
