...
import { PelangganClientSiteReportDto } from 'src/dto/pelanggan/pelanggan.client_site-report.dto';;

@ApiTags('client_site_report')
@Controller('client_site_report')
export class ClientSiteReportController {
    constructor(private readonly service: ClientSiteService) { }

    @Post('list')
    @ApiResponseEntity(PelangganClientSiteReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganClientSiteReportDto, 'get')
