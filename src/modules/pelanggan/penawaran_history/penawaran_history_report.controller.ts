...
import { PenawaranHistoryService } from '../penawaran_history/penawaran_history.service';
...
import { PelangganPenawaranHistoryReportDto } from 'src/dto/pelanggan/pelanggan.penawaran_history-report.dto';;

@ApiTags('penawaran_history_report')
@Controller('penawaran_history_report')
export class PenawaranHistoryReportController {
    constructor(private readonly service: PenawaranHistoryService) { }

    @Post('list')
    @ApiResponseEntity(PelangganPenawaranHistoryReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPenawaranHistoryReportDto, 'get')
