...
@ApiTags('penawaran_history')
@Controller('penawaran_history')
export class PenawaranHistoryController {
    constructor(private readonly service: PenawaranHistoryService) { }

    @Get()
    @ApiResponseEntity(PelangganPenawaranHistoryDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPenawaranHistoryDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPenawaranHistoryDto }) 
    @ApiResponseEntity(PelangganPenawaranHistoryDto, 'post')
    async create(@Body() body: PelangganPenawaranHistoryDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPenawaranHistoryDto })
    @ApiResponseEntity(PelangganPenawaranHistoryDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPenawaranHistoryDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPenawaranHistoryDto, 'delete')
