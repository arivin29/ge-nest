...
import { FakturService } from '../faktur/faktur.service';
...
import { PelangganFakturReportDto } from 'src/dto/pelanggan/pelanggan.faktur-report.dto';;

@ApiTags('faktur_report')
@Controller('faktur_report')
export class FakturReportController {
    constructor(private readonly service: FakturService) { }

    @Post('list')
    @ApiResponseEntity(PelangganFakturReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganFakturReportDto, 'get')
