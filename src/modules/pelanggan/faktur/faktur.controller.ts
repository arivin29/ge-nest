...
export class FakturController {
    ...
    @Get()
    @ApiResponseEntity(PelangganFakturDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganFakturDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganFakturDto }) 
    @ApiResponseEntity(PelangganFakturDto, 'post')
    async create(@Body() body: PelangganFakturDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganFakturDto })
    @ApiResponseEntity(PelangganFakturDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganFakturDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganFakturDto, 'delete')
