...
import { SalesPenjualanService } from '../sales_penjualan/sales_penjualan.service';
...
import { PelangganSalesPenjualanReportDto } from 'src/dto/pelanggan/pelanggan.sales_penjualan-report.dto';;

@ApiTags('sales_penjualan_report')
@Controller('sales_penjualan_report')
export class SalesPenjualanReportController {
    constructor(private readonly service: SalesPenjualanService) { }

    @Post('list')
    @ApiResponseEntity(PelangganSalesPenjualanReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSalesPenjualanReportDto, 'get')
