...
import { SaleShippingService } from '../sale_shipping/sale_shipping.service';
...
import { PelangganSaleShippingReportDto } from 'src/dto/pelanggan/pelanggan.sale_shipping-report.dto';;

@ApiTags('sale_shipping_report')
@Controller('sale_shipping_report')
export class SaleShippingReportController {
    constructor(private readonly service: SaleShippingService) { }

    @Post('list')
    @ApiResponseEntity(PelangganSaleShippingReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSaleShippingReportDto, 'get')
