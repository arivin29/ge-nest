...
@ApiTags('sale_shipping')
@Controller('sale_shipping')
export class SaleShippingController {
    constructor(private readonly service: SaleShippingService) { }

    @Get()
    @ApiResponseEntity(PelangganSaleShippingDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSaleShippingDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganSaleShippingDto }) 
    @ApiResponseEntity(PelangganSaleShippingDto, 'post')
    async create(@Body() body: PelangganSaleShippingDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganSaleShippingDto })
    @ApiResponseEntity(PelangganSaleShippingDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganSaleShippingDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganSaleShippingDto, 'delete')
