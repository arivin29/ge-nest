...
export class ContractSiteController {
    ...
    @Get()
    @ApiResponseEntity(PelangganContractSiteDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContractSiteDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganContractSiteDto }) 
    @ApiResponseEntity(PelangganContractSiteDto, 'post')
    async create(@Body() body: PelangganContractSiteDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganContractSiteDto })
    @ApiResponseEntity(PelangganContractSiteDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganContractSiteDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganContractSiteDto, 'delete')
