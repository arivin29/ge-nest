...
import { PelangganContractSiteReportDto } from 'src/dto/pelanggan/pelanggan.contract_site-report.dto';;
...
export class ContractSiteReportController {
    ...
    @Post('list')
    @ApiResponseEntity(PelangganContractSiteReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContractSiteReportDto, 'get')
