...
@ApiTags('work_schedule_bap')
@Controller('work_schedule_bap')
export class WorkScheduleBapController {
    constructor(private readonly service: WorkScheduleBapService) { }

    @Get()
    @ApiResponseEntity(PelangganWorkScheduleBapDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganWorkScheduleBapDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganWorkScheduleBapDto }) 
    @ApiResponseEntity(PelangganWorkScheduleBapDto, 'post')
    async create(@Body() body: PelangganWorkScheduleBapDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganWorkScheduleBapDto })
    @ApiResponseEntity(PelangganWorkScheduleBapDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganWorkScheduleBapDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganWorkScheduleBapDto, 'delete')
