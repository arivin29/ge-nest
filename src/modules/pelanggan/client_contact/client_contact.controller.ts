...
export class ClientContactController {
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganClientContactDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganClientContactDto }) 
    @ApiResponseEntity(PelangganClientContactDto, 'post')
    async create(@Body() body: PelangganClientContactDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganClientContactDto })
    @ApiResponseEntity(PelangganClientContactDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganClientContactDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganClientContactDto, 'delete')
