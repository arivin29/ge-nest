...
import { ClientContactService } from '../client_contact/client_contact.service';
...
import { PelangganClientContactReportDto } from 'src/dto/pelanggan/pelanggan.client_contact-report.dto';;

@ApiTags('client_contact_report')
@Controller('client_contact_report')
export class ClientContactReportController {
    constructor(private readonly service: ClientContactService) { }

    @Post('list')
    @ApiResponseEntity(PelangganClientContactReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganClientContactReportDto, 'get')
