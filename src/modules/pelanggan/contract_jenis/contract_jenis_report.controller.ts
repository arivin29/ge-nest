...
import { ContractJenisService } from '../contract_jenis/contract_jenis.service';
...
import { PelangganContractJenisReportDto } from 'src/dto/pelanggan/pelanggan.contract_jenis-report.dto';;

@ApiTags('contract_jenis_report')
@Controller('contract_jenis_report')
export class ContractJenisReportController {
    constructor(private readonly service: ContractJenisService) { }

    @Post('list')
    @ApiResponseEntity(PelangganContractJenisReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContractJenisReportDto, 'get')
