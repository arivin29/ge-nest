...
@ApiTags('contract_jenis')
@Controller('contract_jenis')
export class ContractJenisController {
    constructor(private readonly service: ContractJenisService) { }

    @Get()
    @ApiResponseEntity(PelangganContractJenisDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContractJenisDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganContractJenisDto }) 
    @ApiResponseEntity(PelangganContractJenisDto, 'post')
    async create(@Body() body: PelangganContractJenisDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganContractJenisDto })
    @ApiResponseEntity(PelangganContractJenisDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganContractJenisDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganContractJenisDto, 'delete')
