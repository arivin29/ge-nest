...
@ApiTags('sales_barang')
@Controller('sales_barang')
export class SalesBarangController {
    constructor(private readonly service: SalesBarangService) { }

    @Get()
    @ApiResponseEntity(PelangganSalesBarangDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSalesBarangDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganSalesBarangDto }) 
    @ApiResponseEntity(PelangganSalesBarangDto, 'post')
    async create(@Body() body: PelangganSalesBarangDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganSalesBarangDto })
    @ApiResponseEntity(PelangganSalesBarangDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganSalesBarangDto) {
        try { 
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganSalesBarangDto, 'delete')
