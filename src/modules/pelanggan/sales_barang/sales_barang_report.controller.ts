...
import { SalesBarangService } from '../sales_barang/sales_barang.service';
...
import { PelangganSalesBarangReportDto } from 'src/dto/pelanggan/pelanggan.sales_barang-report.dto';;

@ApiTags('sales_barang_report')
@Controller('sales_barang_report')
export class SalesBarangReportController {
    constructor(private readonly service: SalesBarangService) { }

    @Post('list')
    @ApiResponseEntity(PelangganSalesBarangReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganSalesBarangReportDto, 'get')
