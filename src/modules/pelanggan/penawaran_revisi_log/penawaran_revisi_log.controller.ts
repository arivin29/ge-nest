...
import { PelangganPenawaranRevisiLogDto } from 'src/dto/pelanggan/pelanggan.penawaran_revisi_log.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('penawaran_revisi_log')
@Controller('penawaran_revisi_log')
export class PenawaranRevisiLogController {
    constructor(private readonly service: PenawaranRevisiLogService) { }

    @Get()
    @ApiResponseEntity(PelangganPenawaranRevisiLogDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPenawaranRevisiLogDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPenawaranRevisiLogDto }) 
    @ApiResponseEntity(PelangganPenawaranRevisiLogDto, 'post')
    async create(@Body() body: PelangganPenawaranRevisiLogDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPenawaranRevisiLogDto })
    @ApiResponseEntity(PelangganPenawaranRevisiLogDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPenawaranRevisiLogDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPenawaranRevisiLogDto, 'delete')
