...
export class ContactClientUseController {
    ...
    @Get()
    @ApiResponseEntity(PelangganContactClientUseDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContactClientUseDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganContactClientUseDto }) 
    @ApiResponseEntity(PelangganContactClientUseDto, 'post')
    async create(@Body() body: PelangganContactClientUseDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganContactClientUseDto })
    @ApiResponseEntity(PelangganContactClientUseDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganContactClientUseDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganContactClientUseDto, 'delete')
