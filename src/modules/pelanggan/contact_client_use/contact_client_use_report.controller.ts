...
import { ContactClientUseService } from '../contact_client_use/contact_client_use.service';
...
import { PelangganContactClientUseReportDto } from 'src/dto/pelanggan/pelanggan.contact_client_use-report.dto';;

@ApiTags('contact_client_use_report')
@Controller('contact_client_use_report')
export class ContactClientUseReportController {
    constructor(private readonly service: ContactClientUseService) { }

    @Post('list')
    @ApiResponseEntity(PelangganContactClientUseReportDto, 'list') 
    async findAll( 
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganContactClientUseReportDto, 'get')
