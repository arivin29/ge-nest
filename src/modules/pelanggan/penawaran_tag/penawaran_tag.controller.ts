...
import { PelangganPenawaranTagDto } from 'src/dto/pelanggan/pelanggan.penawaran_tag.dto';; 
import { ApiResponseEntity } from 'src/common/decorators/api-response-entity';
 
@ApiTags('penawaran_tag')
@Controller('penawaran_tag')
export class PenawaranTagController {
    constructor(private readonly service: PenawaranTagService) { }

    @Get()
    @ApiResponseEntity(PelangganPenawaranTagDto, 'list')
    @AutoSwaggerQuery()
    ...
    @Get(':id')
    @ApiResponseEntity(PelangganPenawaranTagDto, 'get')
    ...
    @Post()
    @ApiBody({ type: PelangganPenawaranTagDto }) 
    @ApiResponseEntity(PelangganPenawaranTagDto, 'post')
    async create(@Body() body: PelangganPenawaranTagDto) {
        try {
    ...
    @Put(':id')
    @ApiBody({ type: PelangganPenawaranTagDto })
    @ApiResponseEntity(PelangganPenawaranTagDto, 'put')
    async update(@Param('id') id: string, @Body() body: PelangganPenawaranTagDto) {
        try {
    ...
    @Delete(':id')
    @ApiResponseEntity(PelangganPenawaranTagDto, 'delete')
