...
@Entity({ name: 'sk_izin_tdupmamin', schema: 'new_bpt' })
export class NewBptSkIzinTdupmamin {
  ...
  @PrimaryColumn({ name: 'id_sk_izin_tdupmamin' })
  idSkIzinTdupmamin: number;
  ...
  @Column({ name: 'sewa_menyewa', nullable: true })
  sewaMenyewa: string;
