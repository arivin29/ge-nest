...
@Entity({ name: 'sk_izin_ilkp', schema: 'new_bpt' })
export class NewBptSkIzinIlkp {
  @Column({ name: 'alamat_sk_lama', nullable: true })
  alamatSkLama: string;
  ...
  @PrimaryColumn({ name: 'id_sk_izin_ilkp' })
  idSkIzinIlkp: number;
