...
export class AmimsPart {
  ...
  @Column({ name: 'service_contract_type', nullable: true })
  serviceContractType: string;

  @Column({ name: 'service_contract_provider', nullable: true })
  serviceContractProvider: string;

  @Column({ name: 'service_contract_number', nullable: true })
  serviceContractNumber: string;

  @Column({ name: 'service_contract_start', nullable: true })
  serviceContractStart: string;

  @Column({ name: 'service_contract_end', nullable: true })
  serviceContractEnd: string;

  @Column({ name: 'id_aircraft_contract', nullable: true })
  idAircraftContract: string;

  @Column({ name: 'service_contract_note', nullable: true })
